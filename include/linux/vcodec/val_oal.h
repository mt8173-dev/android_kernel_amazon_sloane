 ...
 *   void
 */
void SP5_VCodecMemSet(IN void *pBuffer_VA, IN char cValue, IN unsigned int u4Length);
 ...
 *   void
 */
void SP5_VCodecMemCopy(IN void *pvDest, IN const void *pvSrc, IN unsigned int u4Length);
 ...
 *   void
 */
void SP5_VCodecAssertFail(IN char *ptr, IN int i4Line, IN int i4Arg);
 ...
 *   void
 */
void SP5_VcodecTraceLog0(IN VCODEC_LOG_GROUP_T eGroup, IN VCODEC_LOG_INDEX_T eIndex);
 ...
 *   void
 */
void SP5_VcodecTraceLog1(IN VCODEC_LOG_GROUP_T eGroup, IN VCODEC_LOG_INDEX_T eIndex, IN UINT64 arg);
...
void SP5_VcodecTraceLog2(IN VCODEC_LOG_GROUP_T eGroup,
			 IN VCODEC_LOG_INDEX_T eIndex, IN UINT64 arg1, IN UINT64 arg2);
...
void SP5_VcodecTraceLog4(IN VCODEC_LOG_GROUP_T eGroup,
			 ...
			 IN UINT64 arg1, IN UINT64 arg2, IN UINT64 arg3, IN UINT64 arg4);
...
void SP5_VcodecTraceLog8(IN VCODEC_LOG_GROUP_T eGroup,
			 ...
			 IN UINT64 arg3,
			 IN UINT64 arg4,
			 IN UINT64 arg5, IN UINT64 arg6, IN UINT64 arg7, IN UINT64 arg8);
#else
/**
 * @par Function
 *   SP5_VCodecPrintf
 ...
 *   VAL_VOID_T
 */
VAL_VOID_T SP5_VdoMemAllocAligned(VAL_VOID_T *handle, VAL_UINT32_T size, unsigned int u4AlignSize,
				  VCODEC_MEMORY_TYPE_T cachable, VCODEC_BUFFER_T *pBuf,
 ...
 *   VAL_VOID_T
 */
VAL_VOID_T SP5_VdoIntMalloc(HANDLE handle, unsigned int size, unsigned int alignedsize,
			    VCODEC_BUFFER_T *prBuffer_adr);
 ...
 */
int VCodecDrvPthread_attr_getdetachstate(IN const VCODEC_PTHREAD_ATTR_T * attr,
					 OUT int *detachstate);
 ...
 */
int VCodecDrvPthread_create(OUT VCODEC_PTHREAD_T * thread, IN const VCODEC_PTHREAD_ATTR_T * attr,
			    IN void *(*start_routine) (void *), IN void *arg);
 ...
 */
int VCodecDrvPthread_mutex_init(OUT VCODEC_PTHREAD_MUTEX_T * mutex,
 ...
 */
int VCodecDrvPthread_cond_init(OUT VCODEC_PTHREAD_COND_T * cond,
 ...
 *   VCODEC_OAL_ERROR_T, return VCODEC_OAL_ERROR_NONE if success, return VCODEC_OAL_ERROR_ERROR if failed
 */
VCODEC_OAL_ERROR_T VCodecDrvGetAffinity(IN VCODEC_PTHREAD_T ThreadHandle, OUT unsigned int *pu4Mask,
 ...
 */
VCODEC_OAL_ERROR_T VCodecConfigMCIPort(IN unsigned int u4PortConfig,
 ...
 *   void
 */
void VCodecDrvMemAllocAligned_NC(IN HANDLE hDrv, IN unsigned int u4Size, unsigned int u4AlignSize,
				 IN VCODEC_MEMORY_TYPE_T fgCacheable, OUT VCODEC_BUFFER_T *prBuf);
 ...
 *   void
 */
VCODEC_DEC_ERROR_T VDecCodecQueryInfo(IN HANDLE hDrv, IN VCODEC_DEC_QUERY_INFO_TYPE_T ID,
				      OUT void *pvQueryData);
#if 0
/* MACRO */
