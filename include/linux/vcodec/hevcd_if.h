...
VCODEC_DEC_ERROR_T HEVCDecoderGetMemoryRequired(VCODEC_DEC_INPUT_T *prInput,
						VCODEC_MEMORY_SIZE_T *prMemeorySize,
						VCODEC_DEC_YUV_BUFFER_PARAM_T *
						prYUVBufferParameter,
						OUT VCODEC_MEMORY_TYPE_T *
						prBitStreamBufferMemType);
VCODEC_DEC_ERROR_T HEVCDecoderGetMemoryRequiredExtend(VCODEC_DEC_INPUT_T *prInput,
						      VCODEC_MEMORY_SIZE_T *prMemeorySize,
						      VCODEC_DEC_YUV_BUFFER_PARAM_EXTEND_T *
						      prYUVBufferParameter,
						      OUT VCODEC_DEC_BITSTREAM_PARAM_T *
						      prBitStreamParam, INOUT void *prExtra);
...
VCODEC_DEC_ERROR_T HEVCDecoderGetNextDisplay(IN HANDLE hCodec,
					     OUT VCODEC_DEC_PRIVATE_OUTPUT_T * prPrivateOutput);
VCODEC_DEC_ERROR_T HEVCDecoderGetParameterAdapt(IN HANDLE hCodec, IN VCODEC_DEC_PARAM_TYPE_T eCmd,
						INOUT void *pParam);
VCODEC_DEC_ERROR_T HEVCDecoderSetParameterAdapt(IN HANDLE hCodec, IN VCODEC_DEC_PARAM_TYPE_T eCmd,
						INOUT void *pParam);
