...
typedef enum {
	...
	SENSOR_FEATURE_GET_FACTORY_MODE,
...
typedef enum {
	MIPI_SETTLEDEALY_AUTO = 0,
	MIPI_SETTLEDEALY_MANUAL = 1,
...
typedef struct {
	...
	MUINT8 CameraData[MAXIMUM_NVRAM_CAMERA_SENSOR_FILE_SIZE / 2 - 8 -
