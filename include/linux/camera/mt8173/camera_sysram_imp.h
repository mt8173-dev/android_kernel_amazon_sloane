...
#define MFALSE              false
/* ----------------------------------------------------------------------------- */
#define LOG_TAG "[Camera-SYSRAM]"
#define LOG_MSG(fmt, arg...)    pr_debug(LOG_TAG "[%s] " fmt "\n", __func__, ##arg)
#define LOG_WRN(fmt, arg...)    pr_warn(LOG_TAG "[%s] " fmt "\n", __func__, ##arg)
#define LOG_ERR(fmt, arg...)    pr_err(LOG_TAG "[%s] " fmt "\n", __func__, ##arg)
#define LOG_DMP(fmt, arg...)    pr_debug(LOG_TAG "[%s] " fmt "\n", __func__, ##arg)
