...
#define MTK_HDMI_HDCP_LEVEL                     HDMI_IOWR(97, unsigned int)
#define MTK_HDMI_ENABLE_SUSPEND                 HDMI_IOWR(98, unsigned int)
...
extern int hdmi_get_ovl_pts_log_level(void);
extern int hdmi_get_rdma_pts_log_level(void);
