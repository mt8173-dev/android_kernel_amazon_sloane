...
#define MMC_HS400_MAX_DTR   400000000
	...
	u8			raw_dev_lifetime_est_a;	/* 268 */
	u8			raw_dev_lifetime_est_b;	/* 269 */
...
#define mmc_card_in_ffu_mode(c)	((c) && ((c)->state & MMC_STATE_FFU))
...
#define mmc_card_set_ffu_mode(c)	((c)->state |= MMC_STATE_FFU)
#define mmc_card_clr_ffu_mode(c)	((c)->state &= ~MMC_STATE_FFU)
