...
#define EXT_CSD_SLC_HEALTH_STAT		87	/* R, 1 byte */
#define EXT_CSD_MLC_HEALTH_STAT		94	/* R, 1 byte */
...
#define EXT_CSD_DEV_LIFETIME_EST_A	268	/* RO */
#define EXT_CSD_DEV_LIFETIME_EST_B	269	/* RO */
