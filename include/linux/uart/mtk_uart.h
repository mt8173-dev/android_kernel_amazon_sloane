...
struct mtk_uart {
	...
	struct pinctrl_state            *rx_default;
	struct pinctrl_state            *rx_sleep;
	struct pinctrl_state            *tx_default;
	struct pinctrl_state            *tx_sleep;
};
/*---------------------------------------------------------------------------*/
/* fiq debugger */
/*---------------------------------------------------------------------------*/
...
extern struct mtk_uart_setting mtk_uart_default_settings[];
extern struct clk *PDN_FOR_UART_DMA;
