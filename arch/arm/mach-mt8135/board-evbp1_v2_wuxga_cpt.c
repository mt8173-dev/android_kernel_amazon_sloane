...
#include <mt8135_evbp1_v2_wuxga_cpt/cust_gpio_usage.h>
#include <mt8135_evbp1_v2_wuxga_cpt/cust_eint.h>
#include <mt8135_evbp1_v2_wuxga_cpt/cust_kpd.h>
...
static struct alsps_hw cust_alsps_hw = {
	...
	/* .als_value  = {40, 40, 90,  90, 160, 160,  225,  320,  640,  1280,  1280,
	 *   2600,  2600, 2600,  10240, 10240}, */
	.ps_threshold = 0xFE,
};
...
u8 cust_ctp_cfg_group1[] = { 0x41, 0x00, 0x10, 0x00, 0x10, 0x0A, 0x3D, 0x00,
	0x01, 0x0A, 0x1E, 0x05, 0x64, 0x3C, 0x03, 0x05,
	0x00, 0x00, 0x00, 0x00, 0x12, 0x34, 0x00, 0x18,
	0x1A, 0x1E, 0x14, 0x95, 0x35, 0xDE, 0x34, 0x31,
	0x82, 0x23, 0x00, 0x00, 0x00, 0x03, 0x02, 0x2D,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xC8, 0xC8,
	0x00, 0x00, 0x00, 0x0E, 0x20, 0x4A, 0x07, 0x46,
	0x0F, 0x00, 0x00, 0x8D, 0x20, 0x13, 0x82, 0x23,
	0x15, 0x10, 0x27, 0x16, 0xF4, 0x2D, 0x17, 0xD4,
	...
	0x02, 0x01, 0x00, 0xFF, 0xFF, 0xFF, 0x00, 0x01,
...
signed int cust_tpd_calibration_matrix_rotation_normal[] = { 1919, 0, 0, 0, 1199, 0, 0, 0 };
signed int cust_tpd_calibration_matrix_rotation_factory[] = { 1919, 0, 0, 0, 1199, 0, 0, 0 };
...
static struct gt9xx_platform_data gt9xx_platform_data = {
	...
	.gtp_max_height = 4096,	/* #define GTP_MAX_HEIGHT   4096 */
	.gtp_max_width = 4096,	/* #define GTP_MAX_WIDTH    4096 */
	...
	.tpd_power_source_custom = MT65XX_POWER_LDO_VGP6,
	...
	/* #define TPD_CALIBRATION_MATRIX_ROTATION_NORMAL  {0, -4096, 3272704, -4096, 0, 5238784, 0, 0}; */
	.tpd_calibration_matrix_rotation_normal = cust_tpd_calibration_matrix_rotation_normal,

	/* #define TPD_CALIBRATION_MATRIX_ROTATION_FACTORY {0, -4096, 3272704, -4096, 0, 5238784, 0, 0}; */
	.tpd_calibration_matrix_rotation_factory = cust_tpd_calibration_matrix_rotation_factory,
};
