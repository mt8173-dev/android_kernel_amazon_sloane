...
#define BOARD_ID_abc123				0x0012
#define BOARD_ID_abc123				0x000F
...
/* abc123 */
#define BOARD_REV_abc123_PROTO_2_0		0x0000
#define BOARD_REV_abc123_PROTO_2_1		(BOARD_REV_abc123_PROTO_2_0+1)
#define BOARD_REV_abc123_EVT_1_0		(BOARD_REV_abc123_PROTO_2_1+1)
#define BOARD_REV_abc123_EVT_1_1		(BOARD_REV_abc123_EVT_1_0+1)
#define BOARD_REV_abc123_EVT_2_0		(BOARD_REV_abc123_EVT_1_1+1)
#define BOARD_REV_abc123_DVT			(BOARD_REV_abc123_EVT_2_0+1)
#define BOARD_REV_abc123_PVT			(BOARD_REV_abc123_DVT+1)

/* abc123 */
#define BOARD_REV_abc123_PROTO			0x0000
#define BOARD_REV_abc123_EVT_1_0		(BOARD_REV_abc123_PROTO+1)
#define BOARD_REV_abc123_DVT			(BOARD_REV_abc123_EVT_1_0+1)
#define BOARD_REV_abc123_PVT			(BOARD_REV_abc123_DVT+1)
