...
#ifdef CONFIG_HAS_EARLYSUSPEND
static int g_enable_cpu_rush_boost;
static int g_prev_cpu_rush_boost_enable;
...
static int g_enable_dynamic_cpu_hotplug_at_suspend;
static int g_prev_dynamic_cpu_hotplug_enable;
					    ...
					    size_t count, loff_t *pos)
{
	...
	if (sscanf(desc, "%d", &test1) == 1) {
		...
		case 2:
			...
			printk(KERN_EMERG "SPM_CA7_CPU0_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA7_CPU0_PWR_CON));
			printk(KERN_EMERG "SPM_CA7_CPU1_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA7_CPU1_PWR_CON));
			printk(KERN_EMERG "SPM_CA7_CPU2_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA7_CPU2_PWR_CON));
			printk(KERN_EMERG "SPM_CA7_CPU3_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA7_CPU3_PWR_CON));
			printk(KERN_EMERG "SPM_CA7_DBG_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA7_DBG_PWR_CON));
			printk(KERN_EMERG "SPM_CA7_CPUTOP_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA7_CPUTOP_PWR_CON));
			printk(KERN_EMERG "SPM_CA7_CPU0_L1_PDN: 0x%08x\n",
			       REG_READ(SPM_CA7_CPU0_L1_PDN));
			printk(KERN_EMERG "SPM_CA7_CPU1_L1_PDN: 0x%08x\n",
			       REG_READ(SPM_CA7_CPU1_L1_PDN));
			printk(KERN_EMERG "SPM_CA7_CPU2_L1_PDN: 0x%08x\n",
			       REG_READ(SPM_CA7_CPU2_L1_PDN));
			printk(KERN_EMERG "SPM_CA7_CPU3_L1_PDN: 0x%08x\n",
			       REG_READ(SPM_CA7_CPU3_L1_PDN));
			printk(KERN_EMERG "SPM_CA7_CPUTOP_L2_PDN: 0x%08x\n",
			       REG_READ(SPM_CA7_CPUTOP_L2_PDN));
			printk(KERN_EMERG "SPM_CA15_CPU0_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA15_CPU0_PWR_CON));
			printk(KERN_EMERG "SPM_CA15_CPU1_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA15_CPU1_PWR_CON));
			printk(KERN_EMERG "SPM_CA15_CPU2_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA15_CPU2_PWR_CON));
			printk(KERN_EMERG "SPM_CA15_CPU3_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA15_CPU3_PWR_CON));
			printk(KERN_EMERG "SPM_CA15_CPUTOP_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA15_CPUTOP_PWR_CON));
			printk(KERN_EMERG "SPM_CA15_L1_PWR_CON: 0x%08x\n",
			       REG_READ(SPM_CA15_L1_PWR_CON));
			printk(KERN_EMERG "SPM_CA15_L2_PWR_CON: 0x%08x\n",
...
static int mt_hotplug_mechanism_write_memory_debug(struct file *file, const char __user *buffer,
						   size_t count, loff_t *pos)
{
	int len = 0;
	char desc[32];
...
static int __init mt_hotplug_mechanism_init(void)
{
	...
	if (!mt_hotplug_dir) {
		...
		entry =
		    proc_create("test0", S_IRUGO | S_IWUSR | S_IWGRP, mt_hotplug_dir,
				&mt_hotplug_test0_fops);
		entry =
		    proc_create("test1", S_IRUGO | S_IWUSR | S_IWGRP, mt_hotplug_dir,
				&mt_hotplug_test1_fops);
		entry =
		    proc_create("memory_debug", S_IRUGO | S_IWUSR | S_IWGRP, mt_hotplug_dir,
				&mt_hotplug_memory_debug_fops);
	}
