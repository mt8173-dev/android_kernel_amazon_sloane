...
/*de-glitch*/
#define MTK_WDT_DEGLITCH_BASE    deglitch_base
#define MTK_WDT_DEGLITCH_EN     (MTK_WDT_DEGLITCH_BASE+0x0310)
...
#define MTK_WDT_LENGTH_FIELD_OFFSET     5
#define MTK_WDT_LENGTH_SECOND_TO_TICKS    64
