...
#else
#define INT_POL_CTL0        (mcucfgbase + 0x620)
#define GIC_DIST_BASE       (ca9base + 0x1000)
#define GIC_CPU_BASE        (ca9base + 0x2000)
#endif
/**irq  */
...
#define NR_MT_IRQ_LINE  (GIC_PPI_OFFSET + MT_NR_PPI + MT_NR_SPI)	/* 27
									   Private interrupt and 5 PPIs and 219 SPIs */
...
#define MT8135_PMIC_WRAP_IRQ_ID             (GIC_PRIVATE_SIGNALS + 128)	/*
									   0x80 */
/*
...
#define CAMERA_ISP_IRQ3_ID                  (GIC_PRIVATE_SIGNALS + 144)	/*
									   cam_irq3_b */
...
#define CAMERA_ISP_IRQ2_ID                  (GIC_PRIVATE_SIGNALS + 149)	/*
									   cam_irq2_b */
#define CAMERA_ISP_IRQ1_ID                  (GIC_PRIVATE_SIGNALS + 150)	/*
									   cam_irq1_b */
#define CAMERA_ISP_IRQ0_ID                  (GIC_PRIVATE_SIGNALS + 151)	/*
									   cam_irq_b */
...
#define MT8135_APARM_GPTTIMER_IRQ_LINE      MT8135_GPT_IRQ_ID	/* alias name
								   for GPT */
