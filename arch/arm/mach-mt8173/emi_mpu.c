...
static const struct mst_tbl_entry mst_tbl[] = {
	/* apmcu */
	{.master = MST_ID_APMCU_0, .port = 0x0, .id_mask = 0 b0000000001110, .id_val =
	 0 b0000000001000, .name = "APMCU: CA7"},
	{.master = MST_ID_APMCU_1, .port = 0x0, .id_mask = 0 b0000000001110, .id_val =
	 0 b0000000000110, .name = "APMCU: CA15"},

	{.master = MST_ID_APMCU_2, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0000000000100, .name = "MSDC0"},
	{.master = MST_ID_APMCU_3, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0000010000100, .name = "NFI"},
	{.master = MST_ID_APMCU_4, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0001010000100, .name = "Audio"},
	{.master = MST_ID_APMCU_5, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0010010000100, .name = "MSDC3"},
	{.master = MST_ID_APMCU_6, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0011010000100, .name = "USB20"},
	{.master = MST_ID_APMCU_7, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0000100000100, .name = "MD"},
	{.master = MST_ID_APMCU_8, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0001100000100, .name = "SPM"},
	{.master = MST_ID_APMCU_9, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0010100000100, .name = "MD32"},
	{.master = MST_ID_APMCU_10, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0011100000100, .name = "THERM"},
	{.master = MST_ID_APMCU_11, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0000110000100, .name = "DMA"},
	{.master = MST_ID_APMCU_12, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0000000010100, .name = "PWM"},
	{.master = MST_ID_APMCU_13, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0000100010100, .name = "MSDC1"},
	{.master = MST_ID_APMCU_14, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0001000010100, .name = "MSCD2"},
	{.master = MST_ID_APMCU_15, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0001100010100, .name = "SPIO"},
	{.master = MST_ID_APMCU_16, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0000010010100, .name = "USB30"},
	{.master = MST_ID_APMCU_17, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0000000100100, .name = "GCPU"},
	{.master = MST_ID_APMCU_18, .port = 0x0, .id_mask = 0 b1111101111110, .id_val =
	 0 b0000000110100, .name = "CQ_DMA"},
	{.master = MST_ID_APMCU_19, .port = 0x0, .id_mask = 0 b1111101111110, .id_val =
	 0 b0000001000100, .name = "DebugTop"},
	{.master = MST_ID_APMCU_20, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0011111000100, .name = "Perisys IOMMU"},
	{.master = MST_ID_APMCU_21, .port = 0x0, .id_mask = 0 b1111111111110, .id_val =
	 0 b0011111010100, .name = "Perisys IOMMU"},

	{.master = MST_ID_APMCU_22, .port = 0x0, .id_mask = 0 b1111100001110, .id_val =
	 0 b0000000000010, .name = "GPU"},

	/* MM */
	{.master = MST_ID_MM_0, .port = 0x2, .id_mask = 0 b1111110000000, .id_val =
	 0 b0000000000000, .name = "Larb0"},
	{.master = MST_ID_MM_1, .port = 0x2, .id_mask = 0 b1111110000000, .id_val =
	 0 b0000010000000, .name = "Larb1"},
	{.master = MST_ID_MM_2, .port = 0x2, .id_mask = 0 b1111110000000, .id_val =
	 0 b0000100000000, .name = "Larb2"},
	{.master = MST_ID_MM_3, .port = 0x2, .id_mask = 0 b1111110000000, .id_val =
	 0 b0000110000000, .name = "Larb3"},
	{.master = MST_ID_MM_4, .port = 0x2, .id_mask = 0 b1111110000000, .id_val =
	 0 b0001000000000, .name = "Larb4"},
	{.master = MST_ID_MM_5, .port = 0x2, .id_mask = 0 b1111111111110, .id_val =
	 0 b0001111111100, .name = "M4U"},

	/* Modem */
	{.master = MST_ID_MDMCU_0, .port = 0x3, .id_mask = 0 b0000000000000, .id_val =
	 0 b0000000000000, .name = "MDMCU"},

	/* Modem HW (2G/3G) */
	{.master = MST_ID_MDHW_0, .port = 0x4, .id_mask = 0 b0000000000000, .id_val =
	 0 b0000000000000, .name = "MDHW"},

	/* Periperal */
	{.master = MST_ID_PERI_0, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000000000001, .name = "MSDC0"},
	{.master = MST_ID_PERI_1, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000000010001, .name = "NFI"},
	{.master = MST_ID_PERI_2, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000001010001, .name = "Audio"},
	{.master = MST_ID_PERI_3, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000010010001, .name = "MSDC3"},
	{.master = MST_ID_PERI_4, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000011010001, .name = "USB20"},
	{.master = MST_ID_PERI_5, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000000100001, .name = "MD"},
	{.master = MST_ID_PERI_6, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000001100001, .name = "SPM"},
	{.master = MST_ID_PERI_7, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000010100001, .name = "MD32"},
	{.master = MST_ID_PERI_8, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000011100001, .name = "THERM"},
	{.master = MST_ID_PERI_9, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000000110001, .name = "DMA"},
	{.master = MST_ID_PERI_10, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000000000011, .name = "PWM"},
	{.master = MST_ID_PERI_11, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000000100011, .name = "MSDC1"},
	{.master = MST_ID_PERI_12, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000001000011, .name = "MSCD2"},
	{.master = MST_ID_PERI_13, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000001100011, .name = "SPIO"},
	{.master = MST_ID_PERI_14, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000000010011, .name = "USB30"},
	{.master = MST_ID_PERI_15, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000000000101, .name = "GCPU"},
	{.master = MST_ID_PERI_16, .port = 0x6, .id_mask = 0 b1111111101111, .id_val =
	 0 b0000000000111, .name = "CQ_DMA"},
	{.master = MST_ID_PERI_17, .port = 0x6, .id_mask = 0 b1111111101111, .id_val =
	 0 b0000000001001, .name = "DebugTop"},
	{.master = MST_ID_PERI_18, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000011111001, .name = "Perisys IOMMU"},
	{.master = MST_ID_PERI_19, .port = 0x6, .id_mask = 0 b1111111111111, .id_val =
	 0 b0000011111011, .name = "Perisys IOMMU"},
	{.master = MST_ID_PERI_20, .port = 0x6, .id_mask = 0 b1111100000001, .id_val =
	 0 b0000000000000, .name = "emi_m6 : MFG"},

	/* GPU */
	{.master = MST_ID_GPU_0, .port = 0x7, .id_mask = 0 b1111110000000, .id_val =
	 0 b0000000000000, .name = "emi_m7 : MFG"},
	/* apmcu */
	{.master = MST_ID_APMCU_0, .port = 0x0, .id_mask = 0 b0000000001110, .id_val =
	 0 b0000000001000, .name = "APMCU: CA7"},
	{.master = MST_ID_APMCU_1, .port = 0x0, .id_mask = 0 b0000000001110, .id_val =
