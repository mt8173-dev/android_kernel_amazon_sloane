...
static int MPU6050_ReadGyroData(struct i2c_client *client, char *buf, int bufsize)
{
...
#endif
	{
		...
		obj->data[MPU6050_AXIS_X] = ((s16)
					     ((databuf[MPU6050_AXIS_X * 2 + 1]) |
					      (databuf[MPU6050_AXIS_X * 2] << 8)));
		obj->data[MPU6050_AXIS_Y] = ((s16)
					     ((databuf[MPU6050_AXIS_Y * 2 + 1]) |
					      (databuf[MPU6050_AXIS_Y * 2] << 8)));
		obj->data[MPU6050_AXIS_Z] = ((s16)
					     ((databuf[MPU6050_AXIS_Z * 2 + 1]) |
