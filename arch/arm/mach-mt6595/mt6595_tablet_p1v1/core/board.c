...
struct msdc_hw msdc1_hw = {
	...
	.flags =
	    MSDC_SYS_SUSPEND | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_HIGHSPEED | MSDC_UHS1 |
	    MSDC_DDR | MSDC_SD_NEED_POWER,
#else
	.flags = MSDC_SYS_SUSPEND | MSDC_HIGHSPEED | MSDC_UHS1 | MSDC_DDR | MSDC_SD_NEED_POWER,
#endif
	.dat0rddly = 0,
	.dat1rddly = 0,
	.dat2rddly = 0,
...
#ifdef CUST_EINT_MSDC1_INS_NUM
	.flags =
	    MSDC_SYS_SUSPEND | MSDC_WP_PIN_EN | MSDC_CD_PIN_EN | MSDC_REMOVABLE | MSDC_HIGHSPEED |
	    MSDC_UHS1 | MSDC_DDR,
#else
