...
static void wait_dds_stable(unsigned int target_dds, unsigned int reg_mon, unsigned int wait_count)
{
...
static int fh_dumpregs_proc_read(struct seq_file *m, void *v)
{
	...
	seq_printf(m, "MSDC:0x%08x MM:0x%08x VENC:0x%08x TVD:0x%08x VCODEC:0x%08x\r\n",
		   ...
		   DRV_Reg32(VENCPLL_CON0), DRV_Reg32(TVDPLL_CON0), DRV_Reg32(VCODECPLL_CON0));
	...
	seq_printf(m, "MSDC:0x%08x MM:0x%08x VENC:0x%08x TVD:0x%08x VCODEC:0x%08x\r\n",
		   ...
		   DRV_Reg32(VENCPLL_CON1), DRV_Reg32(TVDPLL_CON1), DRV_Reg32(VCODECPLL_CON1));
