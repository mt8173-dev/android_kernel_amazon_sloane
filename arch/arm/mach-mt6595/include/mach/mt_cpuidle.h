...
#define DORMANT_ALL_OFF	(DORMANT_OUTER_OFF	\
				  ...
				  | DORMANT_GIC_OFF	\
				  | DORMANT_SNOOP_OFF)
#define DORMANT_MODE_MASK	(0x00ff00)

#define CPU_DORMANT_MODE (DORMANT_LOUIS_OFF)
#define CPU_SHUTDOWN_MODE (DORMANT_ALL_OFF)

#define CPU_MCDI_MODE (DORMANT_LOUIS_OFF)
#define CPU_SODI_MODE (DORMANT_LOUIS_OFF | DORMANT_CPUSYS_OFF | DORMANT_GIC_OFF | DORMANT_SNOOP_OFF)
#define CPU_DEEPIDLE_MODE (DORMANT_LOUIS_OFF | DORMANT_GIC_OFF | DORMANT_SNOOP_OFF)
