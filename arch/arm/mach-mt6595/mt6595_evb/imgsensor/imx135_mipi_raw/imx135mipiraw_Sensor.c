...
static struct IMX135MIPI_sensor_STRUCT IMX135MIPI_sensor =
    { IMX135MIPI_WRITE_ID, IMX135MIPI_READ_ID, KAL_TRUE, KAL_FALSE, KAL_TRUE, KAL_FALSE,
	KAL_FALSE, KAL_FALSE, KAL_FALSE, 231270000, 231270000, 259200000, 0, 0, 0, 64, 64, 64,
	IMX135MIPI_PV_LINE_LENGTH_PIXELS,
	IMX135MIPI_PV_FRAME_LENGTH_LINES, IMX135MIPI_VIDEO_LINE_LENGTH_PIXELS,
	IMX135MIPI_VIDEO_FRAME_LENGTH_LINES, IMX135MIPI_FULL_LINE_LENGTH_PIXELS,
	IMX135MIPI_FULL_FRAME_LENGTH_LINES, 0, 0, 0, 0, 0, 0, 30
};
#else
static struct IMX135MIPI_sensor_STRUCT IMX135MIPI_sensor = {
	...
	359560000,		/* kal_uint32 video_pclk;                              //video Pclk */
...
void VideoFullSizeSetting(void)
{				/* 16:9   6M */
	...
	IMX135MIPI_write_cmos_sensor(0x331D, 0x60);	/*  */
...
void VideoHDSetting_120fps(void)
{				/* 16:9   6M */
	SENSORDB("VideoFullSizeSetting enter:\n");
	...
	/* Size setting */
	IMX135MIPI_write_cmos_sensor(0x0340, (IMX135MIPI_VIDEO1_FRAME_LENGTH_LINES >> 8) & 0xFF);	/*  */
	IMX135MIPI_write_cmos_sensor(0x0341, (IMX135MIPI_VIDEO1_FRAME_LENGTH_LINES >> 0) & 0xFF);	/*  */
	IMX135MIPI_write_cmos_sensor(0x0342, (IMX135MIPI_VIDEO1_LINE_LENGTH_PIXELS >> 8) & 0xFF);	/*  */
	IMX135MIPI_write_cmos_sensor(0x0343, (IMX135MIPI_VIDEO1_LINE_LENGTH_PIXELS >> 0) & 0xFF);	/*  */
...
UINT32 IMX135MIPISetVideoMode(UINT16 u2FrameRate)
{
	...
	IMX135MIPI_Video_Max_Expourse_Time =
	    (kal_uint16) ((IMX135MIPI_sensor.video_pclk * 10 / u2FrameRate) /
			  IMX135MIPI_sensor.video_line_length);
	...
	if (IMX135MIPI_Video_Max_Expourse_Time >
		...
		IMX135MIPI_sensor.video_dummy_lines =
		    IMX135MIPI_sensor.video_frame_length - IMX135MIPI_VIDEO_FRAME_LENGTH_LINES;
		spin_unlock(&imx135_drv_lock);
		SENSORDB("[IMX135MIPI]%s():frame_length=%d,dummy_lines=%d\n", __func__,
			 IMX135MIPI_sensor.video_frame_length, IMX135MIPI_sensor.video_dummy_lines);
		IMX135MIPI_SetDummy(IMX135MIPI_sensor.video_dummy_pixels,
				    IMX135MIPI_sensor.video_dummy_lines);
	}
	spin_lock(&imx135_drv_lock);
...
UINT32 IMX135MIPISetTestPatternMode(kal_bool bEnable)
{				/* daikan */
