 ...
 */
static ssize_t mcu_dvt_store(struct device_driver *driver, const char *buf, size_t count)
{
	char *p = (char *)buf;
	unsigned int num;
...
int mt_mcu_init(void)
{
	...
	dbg_printk("CPU0-PC:0x%x,CPU1-PC:0x%x,CPU2-PC:0x%x,CPU3-PC:0x%x\n", readl(0xF0200300),
		   readl(0xF0200310), readl(0xF0200320), readl(0xF0200330));
	dbg_printk("CPU0-FP:0x%x,CPU1-FP:0x%x,CPU2-FP:0x%x,CPU3-FP:0x%x\n", readl(0xF0200304),
		   readl(0xF0200314), readl(0xF0200324), readl(0xF0200334));
	dbg_printk("CPU0-SP:0x%x,CPU1-SP:0x%x,CPU2-SP:0x%x,CPU3-SP:0x%x\n", readl(0xF0200308),
		   readl(0xF0200318), readl(0xF0200328), readl(0xF0200338));
#endif
