...
extern int mt_led_set_breath_time(U32 isink_channel, U32 breath_time);
extern int mt_led_set_breath_mode(U32 isink_channel, U32 isink_mode);
...
extern int generate_led_pattern(enum mt65xx_led_pattern led_pattern);
extern int mt_led_set_step_current(U32 isink_channel, U32 step_current);
