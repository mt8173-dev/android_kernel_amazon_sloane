...
{
	DPI_POLARITY clk_pol, de_pol, hsync_pol = 0, vsync_pol = 0;
	unsigned int dpi_clock = 0;	/* /khz */
	unsigned int dpi_clk_div, /* dpi_clk_duty, */ hsync_pulse_width = 0, hsync_back_porch = 0,
