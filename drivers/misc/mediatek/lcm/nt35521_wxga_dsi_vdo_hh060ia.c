...
#define GPIO_LCD_STB_EN      GPIOEXT16
#define GPIO_LCD_BL_EN       GPIOEXT14
#define GPIO_LCD_LED_EN      GPIOEXT15
 ...
 * (20131014 Initial code_for Compal_abc123 v0.04.xls)
 */
 ...
 * (Initial code_for Compal_6 inch abc123_20131114.xls)
...
static void init_inx_lcm(void)
{
	 ...
	 * Initial code_for Compal_6 inch abc123_EVT1.xls
	 * Only one change for abc123-2060: Monitor the MIPI
 ...
 * ([LGD] abc123_EVT1_V01_140116.txt)
 * Change Note: update for Gamma, VGL, Power consumption and GIP Control
 *
 * Updated for EVT2 LGD panel
 * ([LGD] abc123_EVT2_V03_140325.txt)
 * Change Note: (abc123_EVT2_Initial_Code_update_140325.pdf)
...
static void init_lg_lcm(void)
{
	...
	/* abc123-2060: Avoid EVT1 LGD panel impdeance issue
