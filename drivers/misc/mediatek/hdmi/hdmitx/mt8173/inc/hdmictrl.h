...
#define IO_PAD_SCL_PD (1<<3)
#define IO_PAD_SDA_PD (1<<4)
#define IO_PAD_HOT_PLUG_PD (1<<5)
#define IO_PAD_EN 0x110
#define IO_PAD_SCL_EN (1<<3)
#define IO_PAD_SDA_EN (1<<4)
...
#define vWriteINFRASYSMsk(dAddr, dVal, dMsk) (vWriteINFRASYS((dAddr), (dReadINFRASYS(dAddr) & (~(dMsk))) | ((dVal) & (dMsk))))
...
#define vWriteHdmiCECMsk(dAddr, dVal, dMsk) (vWriteHdmiCEC((dAddr), (dReadHdmiCEC(dAddr) & (~(dMsk))) | ((dVal) & (dMsk))))
...
#define vWritePeriSYSMsk(dAddr, dVal, dMsk) (vWriteINFRASYS((dAddr), (dReadINFRASYS(dAddr) & (~(dMsk))) | ((dVal) & (dMsk))))
