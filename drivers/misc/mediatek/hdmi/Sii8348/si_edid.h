...
typedef enum {
	DBTC_TERMINATOR = 0, DBTC_AUDIO_DATA_BLOCK = 1, DBTC_VIDEO_DATA_BLOCK =
	    2, DBTC_VENDOR_SPECIFIC_DATA_BLOCK = 3, DBTC_SPEAKER_ALLOCATION_DATA_BLOCK =
	    4, DBTC_VESA_DTC_DATA_BLOCK = 5
	    /* reserved                          = 6 */
...
typedef enum {
	ETC_VIDEO_CAPABILITY_DATA_BLOCK = 0, ETC_VENDOR_SPECIFIC_VIDEO_DATA_BLOCK =
	    1, ETC_VESA_VIDEO_DISPLAY_DEVICE_INFORMATION_DATA_BLOCK = 2, ETC_VESA_VIDEO_DATA_BLOCK =
	    3, ETC_HDMI_VIDEO_DATA_BLOCK = 4, ETC_COLORIMETRY_DATA_BLOCK = 5, ETC_VIDEO_RELATED =
	    6, ETC_CEA_MISC_AUDIO_FIELDS = 16, ETC_VENDOR_SPECIFIC_AUDIO_DATA_BLOCK =
	    17, ETC_HDMI_AUDIO_DATA_BLOCK = 18, ETC_AUDIO_RELATED = 19, ETC_GENERAL = 32
} extended_tag_code_e;
...
typedef enum {
	/* reserved             =  0 */
	afd_linear_PCM_IEC60958 = 1, afd_AC3 = 2, afd_MPEG1_layers_1_2 = 3, afd_MPEG1_layer_3 =
	    4, afdMPEG2_MultiChannel = 5, afd_AAC = 6, afd_DTS = 7, afd_ATRAC =
	    8, afd_one_bit_audio = 9, afd_dolby_digital = 10, afd_DTS_HD = 11, afd_MAT_MLP =
	    12, afd_DST = 13, afd_WMA_Pro = 14
	    /* reserved              = 15 */
} AudioFormatCodes_e;
...
typedef enum {
	imsz_NO_ADDITIONAL = 0, imsz_ASPECT_RATIO_CORRECT_BUT_NO_GUARRANTEE_OF_CORRECT_SIZE =
	    1, imsz_CORRECT_SIZES_ROUNDED_TO_NEAREST_1_CM =
	    2, imsz_CORRECT_SIZES_DIVIDED_BY_5_ROUNDED_TO_NEAREST_5_CM = 3
} image_size_e;
...
typedef struct SI_PACK_THIS_STRUCT
 _VSDB_all_fields_byte_9_through_byte_15_sans_progressive_latency_t {
	uint8_t interlaced_video_latency;
	uint8_t interlaced_audio_latency;
	VSDB_byte_13_through_byte_15_t byte_13_through_byte_15;
	/* There must be no fields after here */
...
typedef enum {
	ceou_NEITHER = 0, ceou_ALWAYS_OVERSCANNED = 1, ceou_ALWAYS_UNDERSCANNED = 2, ceou_BOTH = 3
} CE_overscan_underscan_behavior_e;

typedef enum {
	itou_NEITHER = 0, itou_ALWAYS_OVERSCANNED = 1, itou_ALWAYS_UNDERSCANNED = 2, itou_BOTH = 3
} IT_overscan_underscan_behavior_e;

typedef enum {
	ptou_NEITHER = 0, ptou_ALWAYS_OVERSCANNED = 1, ptou_ALWAYS_UNDERSCANNED = 2, ptou_BOTH = 3
...
typedef enum {
	iar_16_to_10 = 0, iar_4_to_3 = 1, iar_5_to_4 = 2, iar_16_to_9 = 3
...
typedef enum {
	vif_single_frame_rate = 0x00, vif_dual_frame_rate = 0x01
} VIC_info_flags_e;

typedef enum {
	vsm_progressive = 0, vsm_interlaced = 1
} VIC_scan_mode_e;

typedef enum {
	par_1_to_1, par_16_to_15, par_16_to_27, par_16_to_45, par_16_to_45_160_to_45,
	par_1_to_15_10_to_15, par_1_to_9_10_to_9, par_2_to_15_20_to_15, par_2_to_9,
	par_2_to_9_20_to_9, par_32_to_27, par_32_to_45, par_4_to_27_40_to_27, par_4_to_9,
	par_4_to_15, par_64_to_45, par_8_to_15, par_8_to_27, par_8_to_27_80_to_27,
	par_8_to_45_80_to_45, par_8_to_9
