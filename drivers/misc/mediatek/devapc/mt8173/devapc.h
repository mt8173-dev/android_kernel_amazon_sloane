...
/* DAPC Clock Address */
#define INFRA_PDN0                  ((P_kal_uint32)(devapc_clk_base+0x0070))	/* Disable PDN_CLK  (SET[0]) */
#define INFRA_PDN1                  ((P_kal_uint32)(devapc_clk_base+0x0074))	/* Enable PDN_CLK   (CLR[0]) */
#define INFRA_PDN_STA               ((P_kal_uint32)(devapc_clk_base+0x0078))	/* PDN_CLK Status   (STA[0]: 0 -> Enable, 1 -> Disable) */
