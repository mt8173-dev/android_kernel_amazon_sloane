...
#define __wmt_func(log_pri, gate_pri, fmt, arg...) do { \
	if (gWmtDbgLvl >= gate_pri) \
		printk(log_pri DFT_TAG fmt, __func__ , ##arg); \
} while (0)

#define WMT_LOUD_FUNC(fmt, arg...)     __wmt_func(KERN_DEBUG,   WMT_LOG_LOUD, "[L]%s:" fmt, ##arg)
#define WMT_INFO_FUNC(fmt, arg...)     __wmt_func(KERN_WARNING,   WMT_LOG_INFO, "[I]%s:" fmt, ##arg)
#define WMT_WARN_FUNC(fmt, arg...)     __wmt_func(KERN_WARNING, WMT_LOG_WARN, "[W]%s:" fmt, ##arg)
#define WMT_DBG_FUNC(fmt, arg...)      __wmt_func(KERN_DEBUG,   WMT_LOG_DBG,  "[D]%s:" fmt, ##arg)
#define WMT_ERR_FUNC(fmt, arg...)      __wmt_func(KERN_ERR,     WMT_LOG_ERR,  "[E]%s(%d):" fmt, __LINE__, ##arg)
#define WMT_TRC_FUNC(fmt)              __wmt_func(KERN_DEBUG,   WMT_LOG_TRC,  "[T]%s(%d):" fmt, __LINE__)
