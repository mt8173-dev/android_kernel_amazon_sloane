...
/* cb byte GLUE_CB_OFFSET+4 */
#define GLUE_SET_PKT_TID(_p, _tid) { \
	((*((PUINT_8) & (((struct sk_buff *)(_p))->cb[GLUE_CB_OFFSET+4]))) &= ~(BITS(0, 2))); \
	    (*((PUINT_8) & (((struct sk_buff *)(_p))->cb[GLUE_CB_OFFSET+4])) |= (((UINT_8)((_tid) & (BITS(0, 2)))))); \
    }
...
/* cb byte GLUE_CB_OFFSET+12 */
#define GLUE_SET_PKT_BSS_IDX(_p, _ucBssIndex)      \
	    (*((PUINT_8) & (((struct sk_buff *)(_p))->cb[GLUE_CB_OFFSET+12])) = (UINT_8)(_ucBssIndex))

#define GLUE_GET_PKT_BSS_IDX(_p)      \
	    (*((PUINT_8) & (((struct sk_buff *)(_p))->cb[GLUE_CB_OFFSET+12])))

/* cb byte GLUE_CB_OFFSET+13 */
#define GLUE_SET_PKT_FLAG_PROTECTED_1X(_p) \
	    (*((PUINT_8) & (((struct sk_buff *)(_p))->cb[GLUE_CB_OFFSET+13])) |= BIT(0))

#define GLUE_GET_PKT_IS_PROTECTED_1X(_p) \
	    ((*((PUINT_8) & (((struct sk_buff *)(_p))->cb[GLUE_CB_OFFSET+13]))) & (BIT(0)))

/* cb byte GLUE_CB_OFFSET+(14~15) */
#define GLUE_SET_PKT_IP_ID(_p, _u2IpId) \
	     (*((PUINT_16) & (((struct sk_buff *)(_p))->cb[GLUE_CB_OFFSET+14])) = (UINT_16)(_u2IpId))

#define GLUE_GET_PKT_IP_ID(_p)    \
	     (*((PUINT_16) & (((struct sk_buff *)(_p))->cb[GLUE_CB_OFFSET+14])))

/* cb byte GLUE_CB_OFFSET+16 */
#define GLUE_SET_PKT_FLAG_PROF_MET(_p) \
	    (*((PUINT_8) & (((struct sk_buff *)(_p))->cb[GLUE_CB_OFFSET+16])) |= BIT(0))
