...
/* #include <mach/irqs.h> */
#include "include/mach/mtk_rtc_hal.h"
...
static void rtc_lp_exception(u16 irqsta)
{
...
void hal_rtc_save_pwron_time(bool enable, struct rtc_time *tm, bool logo)
{
	...
	spar1 =
	    (tm->
	     tm_mday << RTC_SPAR1_PWRON_DOM_SHIFT) | (tm->tm_hour << RTC_SPAR1_PWRON_HOU_SHIFT) |
...
void hal_write_dcxo_c2(u16 val, bool flag)
{
	...
	hal_rtc_xinfo(" dcxo_trim1_c2 = 0x%4x,dcxo_trim2_c2 = 0x%4x\n", dcxo_trim1_c2,
		      dcxo_trim2_c2);
	hal_rtc_xinfo(" rgs_dcxo_c2 = 0x%4x,value = %x\n", rgs_dcxo_c2, value);
...
/*add for 26M FT frequency trimming .*/
