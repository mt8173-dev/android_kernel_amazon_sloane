...
int mt_set_gpio_pull_enable_base(unsigned long pin, unsigned long enable)
{
	...
	for (i = 0; i < sizeof(sim_pupd_spec) / sizeof(sim_pupd_spec[0]); i++) {
		if (pin == sim_pupd_spec[i].pin) {
			if (enable == GPIO_PULL_DISABLE) {
				GPIO_SET_BITS((3L << (sim_pupd_spec[i].bit - 2)),
					      &reg->sim_ctrl[sim_pupd_spec[i].reg].rst);
			} else {
				GPIO_SET_BITS((2L << (sim_pupd_spec[i].bit - 2)), &reg->sim_ctrl[sim_pupd_spec[i].reg].set);	/* 5K: 2'b10 */
				GPIO_SET_BITS((1L << (sim_pupd_spec[i].bit - 2)),
					      &reg->sim_ctrl[sim_pupd_spec[i].reg].rst);
			}
			return RSUCCESS;
		}
...
int mt_get_gpio_pull_enable_base(unsigned long pin)
{
	...
	for (i = 0; i < sizeof(sim_pupd_spec) / sizeof(sim_pupd_spec[0]); i++) {
		if (pin == sim_pupd_spec[i].pin) {
			return (((GPIO_RD32(&reg->sim_ctrl[sim_pupd_spec[i].reg].val) &
				  (3L << (sim_pupd_spec[i].bit - 2))) != 0) ? 1 : 0);
		}
	}
	/*********************************DPI special*********************************/
	if (pin == GPIO138) {	/* dpi ck */
...
int mt_set_gpio_pull_select_base(unsigned long pin, unsigned long select)
{
	...
	for (i = 0; i < sizeof(sim_pupd_spec) / sizeof(sim_pupd_spec[0]); i++) {
		if (pin == sim_pupd_spec[i].pin) {
			if (select == GPIO_PULL_DOWN)
				GPIO_SET_BITS((1L << sim_pupd_spec[i].bit),
					      &reg->sim_ctrl[sim_pupd_spec[i].reg].set);
			else
				GPIO_SET_BITS((1L << sim_pupd_spec[i].bit),
					      &reg->sim_ctrl[sim_pupd_spec[i].reg].rst);
			return RSUCCESS;
...
void mt_gpio_suspend(void)
{
	...
	unsigned long GPIO_SUSPEND_STATE[197] = {
		GPIO0_SLEEP_STATE, GPIO1_SLEEP_STATE, GPIO2_SLEEP_STATE, GPIO3_SLEEP_STATE,
		GPIO4_SLEEP_STATE,
		GPIO5_SLEEP_STATE, GPIO6_SLEEP_STATE, GPIO7_SLEEP_STATE, GPIO8_SLEEP_STATE,
		GPIO9_SLEEP_STATE,
		GPIO10_SLEEP_STATE, GPIO11_SLEEP_STATE, GPIO12_SLEEP_STATE, GPIO13_SLEEP_STATE,
		GPIO14_SLEEP_STATE,
		GPIO15_SLEEP_STATE, GPIO16_SLEEP_STATE, GPIO17_SLEEP_STATE, GPIO18_SLEEP_STATE,
		GPIO19_SLEEP_STATE,
		GPIO20_SLEEP_STATE, GPIO21_SLEEP_STATE, GPIO22_SLEEP_STATE, GPIO23_SLEEP_STATE,
		GPIO24_SLEEP_STATE,
		GPIO25_SLEEP_STATE, GPIO26_SLEEP_STATE, GPIO27_SLEEP_STATE, GPIO28_SLEEP_STATE,
		GPIO29_SLEEP_STATE,
		GPIO30_SLEEP_STATE, GPIO31_SLEEP_STATE, GPIO32_SLEEP_STATE, GPIO33_SLEEP_STATE,
		GPIO34_SLEEP_STATE,
		GPIO35_SLEEP_STATE, GPIO36_SLEEP_STATE, GPIO37_SLEEP_STATE, GPIO38_SLEEP_STATE,
		GPIO39_SLEEP_STATE,
		GPIO40_SLEEP_STATE, GPIO41_SLEEP_STATE, GPIO42_SLEEP_STATE, GPIO43_SLEEP_STATE,
		GPIO44_SLEEP_STATE,
		GPIO45_SLEEP_STATE, GPIO46_SLEEP_STATE, GPIO47_SLEEP_STATE, GPIO48_SLEEP_STATE,
		GPIO49_SLEEP_STATE,
		GPIO50_SLEEP_STATE, GPIO51_SLEEP_STATE, GPIO52_SLEEP_STATE, GPIO53_SLEEP_STATE,
		GPIO54_SLEEP_STATE,
		GPIO55_SLEEP_STATE, GPIO56_SLEEP_STATE, GPIO57_SLEEP_STATE, GPIO58_SLEEP_STATE,
		GPIO59_SLEEP_STATE,
		GPIO60_SLEEP_STATE, GPIO61_SLEEP_STATE, GPIO62_SLEEP_STATE, GPIO63_SLEEP_STATE,
		GPIO64_SLEEP_STATE,
		GPIO65_SLEEP_STATE, GPIO66_SLEEP_STATE, GPIO67_SLEEP_STATE, GPIO68_SLEEP_STATE,
		GPIO69_SLEEP_STATE,
		GPIO70_SLEEP_STATE, GPIO71_SLEEP_STATE, GPIO72_SLEEP_STATE, GPIO73_SLEEP_STATE,
		GPIO74_SLEEP_STATE,
		GPIO75_SLEEP_STATE, GPIO76_SLEEP_STATE, GPIO77_SLEEP_STATE, GPIO78_SLEEP_STATE,
		GPIO79_SLEEP_STATE,
		GPIO80_SLEEP_STATE, GPIO81_SLEEP_STATE, GPIO82_SLEEP_STATE, GPIO83_SLEEP_STATE,
		GPIO84_SLEEP_STATE,
		GPIO85_SLEEP_STATE, GPIO86_SLEEP_STATE, GPIO87_SLEEP_STATE, GPIO88_SLEEP_STATE,
		GPIO89_SLEEP_STATE,
		GPIO90_SLEEP_STATE, GPIO91_SLEEP_STATE, GPIO92_SLEEP_STATE, GPIO93_SLEEP_STATE,
		GPIO94_SLEEP_STATE,
		GPIO95_SLEEP_STATE, GPIO96_SLEEP_STATE, GPIO97_SLEEP_STATE, GPIO98_SLEEP_STATE,
		GPIO99_SLEEP_STATE,
		GPIO100_SLEEP_STATE, GPIO101_SLEEP_STATE, GPIO102_SLEEP_STATE, GPIO103_SLEEP_STATE,
		GPIO104_SLEEP_STATE,
		GPIO110_SLEEP_STATE, GPIO111_SLEEP_STATE, GPIO112_SLEEP_STATE, GPIO113_SLEEP_STATE,
		GPIO114_SLEEP_STATE,
		GPIO115_SLEEP_STATE, GPIO116_SLEEP_STATE, GPIO117_SLEEP_STATE, GPIO118_SLEEP_STATE,
		GPIO119_SLEEP_STATE,
		GPIO120_SLEEP_STATE, GPIO121_SLEEP_STATE, GPIO122_SLEEP_STATE, GPIO123_SLEEP_STATE,
		GPIO124_SLEEP_STATE,
		GPIO125_SLEEP_STATE, GPIO126_SLEEP_STATE, GPIO127_SLEEP_STATE, GPIO128_SLEEP_STATE,
		GPIO129_SLEEP_STATE,
		GPIO130_SLEEP_STATE, GPIO131_SLEEP_STATE, GPIO132_SLEEP_STATE, GPIO133_SLEEP_STATE,
		GPIO134_SLEEP_STATE,
		GPIO135_SLEEP_STATE, GPIO136_SLEEP_STATE, GPIO137_SLEEP_STATE, GPIO138_SLEEP_STATE,
		GPIO139_SLEEP_STATE,
		GPIO140_SLEEP_STATE, GPIO141_SLEEP_STATE, GPIO142_SLEEP_STATE, GPIO143_SLEEP_STATE,
		GPIO144_SLEEP_STATE,
		GPIO145_SLEEP_STATE, GPIO146_SLEEP_STATE, GPIO147_SLEEP_STATE, GPIO148_SLEEP_STATE,
		GPIO149_SLEEP_STATE,
		GPIO150_SLEEP_STATE, GPIO151_SLEEP_STATE, GPIO152_SLEEP_STATE, GPIO153_SLEEP_STATE,
		GPIO154_SLEEP_STATE,
		GPIO155_SLEEP_STATE, GPIO156_SLEEP_STATE, GPIO157_SLEEP_STATE, GPIO158_SLEEP_STATE,
		GPIO159_SLEEP_STATE,
		GPIO160_SLEEP_STATE, GPIO161_SLEEP_STATE, GPIO162_SLEEP_STATE, GPIO163_SLEEP_STATE,
		GPIO164_SLEEP_STATE,
		GPIO165_SLEEP_STATE, GPIO166_SLEEP_STATE, GPIO167_SLEEP_STATE, GPIO168_SLEEP_STATE,
		GPIO169_SLEEP_STATE,
		GPIO170_SLEEP_STATE, GPIO171_SLEEP_STATE, GPIO172_SLEEP_STATE, GPIO173_SLEEP_STATE,
		GPIO174_SLEEP_STATE,
		GPIO175_SLEEP_STATE, GPIO176_SLEEP_STATE, GPIO177_SLEEP_STATE, GPIO178_SLEEP_STATE,
		GPIO179_SLEEP_STATE,
		GPIO180_SLEEP_STATE, GPIO181_SLEEP_STATE, GPIO182_SLEEP_STATE, GPIO183_SLEEP_STATE,
		GPIO184_SLEEP_STATE,
		GPIO185_SLEEP_STATE, GPIO186_SLEEP_STATE, GPIO187_SLEEP_STATE, GPIO188_SLEEP_STATE,
		GPIO189_SLEEP_STATE,
		GPIO190_SLEEP_STATE, GPIO191_SLEEP_STATE, GPIO192_SLEEP_STATE, GPIO193_SLEEP_STATE,
		GPIO194_SLEEP_STATE,
	...
	for (i = 0; i < 197; i++) {
		...
		case INPUT_PU:
			if ((dir != GPIO_DIR_IN) || (pullen != GPIO_PULL_ENABLE)
			    || (pullsel != GPIO_PULL_UP)) {
				/* add log */
			}
			break;
		case INPUT_PD:
			if ((dir != GPIO_DIR_IN) || (pullen != GPIO_PULL_ENABLE)
			    || (pullsel != GPIO_PULL_DOWN)) {
				/* add log */
			}
			break;
		case INPUT_NOPULL:
		...
		case OUTPUT_DONT_CARE_and_INPUT_PD:
			if ((dir == GPIO_DIR_IN)
			    && ((pullen != GPIO_PULL_ENABLE) || (pullsel != GPIO_PULL_DOWN))) {
				/* add log */
			}
			break;
...
{
	/* Dummy function just to build pass */
