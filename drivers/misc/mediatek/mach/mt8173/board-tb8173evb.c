...
#include <tb8173evb/cust_gpio_usage.h>
#include <tb8173evb/cust_eint.h>
#include <mach/mt_cam.h>

#include <cust/accdet_custom.h>

#include "tb8173evb/board-custom.h"
...
const int camera_i2c_bus_num1 = 2;
...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	...
	{"lcd-backlight", MT65XX_LED_MODE_CUST_BLS_PWM, (long long)disp_bls_set_backlight,
	 {0, 0, 0, 0, 0} },
};
...
struct mtk_kpd_hardware mtk_kpd_hw = {
	...
	.kcol = {
		...
		[2] =  MT8173_PIN_124_KPCOL2__FUNC_KCOL2,
	},
};
