...
__cpuxgpt6_irq_handler, __cpuxgpt7_irq_handler,}; /* support 8 timer call back */
...
/* pr_err("clock-frequency not set in the .dts file"); */
	...
	pr_alert(
		"mt_cpuxgpt_init: cpuxgpt_regs=0x%lx, irq0=%d, irq1=%d, irq2=%d, irq3=%d, irq4=%d, irq5=%d, irq6=%d, irq7=%d\n",
		(unsigned long)cpuxgpt_regs, cpuxgpt_irq[0], cpuxgpt_irq[1], cpuxgpt_irq[2],
		cpuxgpt_irq[3], cpuxgpt_irq[4], cpuxgpt_irq[5], cpuxgpt_irq[6], cpuxgpt_irq[7]);
