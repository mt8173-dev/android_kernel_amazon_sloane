...
#define MD32_SEMAPHORE (md32reg.cfg  + 0x90)
#define MD32_CFGREG_SIZE 0x90
#endif
...
typedef struct {
	int info_type;
	unsigned long app_ptr_d;
	unsigned long app_ptr_p;
	unsigned long swap_lock_addr;
	int group_num;
	unsigned long app_d_area;
	unsigned long app_p_area;
} MD32_GROUP_INFO;
