 ...
 */
#ifdef CONFIG_OF
#define  EINT_BASE            eint_base_addr
#else
...
/* #define EINT_D2_EN_BASE       ((EINT_BASE + 0x440)) //need remove@8173 */
...
#define EINT_EMUL_BASE        ((EINT_BASE + 0xF00))	/* need remove@8173 */
...
/* #define EINT_D2EN_DEFAULT     0x00000000 //need remove@8173 */
...
#define EINT_DOMAIN_NUM 2

struct eint_domain_config {
	u16 start;
	u16 size;
	bool valid;
};
...
void mt_eint_read_irq_status(u32 *regs, int nregs);
