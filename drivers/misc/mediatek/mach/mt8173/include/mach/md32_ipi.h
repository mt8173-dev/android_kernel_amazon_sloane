...
#if 0
#define MD32_TO_HOST_ADDR (MD32_BASE + 0x001C)

#define MD32_TO_HOST_REG        (*(volatile unsigned int *)(MD32_TO_HOST_ADDR))
#define MD32_MD32_TO_SPM_REG    (*(volatile unsigned int *)(MD32_BASE + 0x0020))
#define HOST_TO_MD32_REG        (*(volatile unsigned int *)(MD32_BASE + 0x0024))
#define MD32_SPM_TO_MD32_REG    (*(volatile unsigned int *)(MD32_BASE + 0x0028))
#define MD32_DEBUG_PC_REG       (*(volatile unsigned int *)(MD32_BASE + 0x0060))
#define MD32_DEBUG_R14_REG      (*(volatile unsigned int *)(MD32_BASE + 0x0064))
#define MD32_DEBUG_R15_REG      (*(volatile unsigned int *)(MD32_BASE + 0x0068))
#define MD32_WDT_REG            (*(volatile unsigned int *)(MD32_BASE + 0x0084))
#define MD32_TO_SPM_REG         (*(volatile unsigned int *)(MD32_BASE + 0x0020))
