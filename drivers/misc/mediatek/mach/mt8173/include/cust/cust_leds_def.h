...
enum mt65xx_led_pattern {
	MT65XX_LED_PMIC_OFF = 0,
	MT65XX_LED_PMIC_WHITE_BLINK,
	MT65XX_LED_PMIC_AMBER_BLINK,
	MT65XX_LED_PMIC_WHITE_ON,
	MT65XX_LED_PMIC_AMBER_ON,
	MT65XX_LED_PMIC_WHITE_BREATHE,
	MT65XX_LED_PMIC_AMBER_BREATHE
};
