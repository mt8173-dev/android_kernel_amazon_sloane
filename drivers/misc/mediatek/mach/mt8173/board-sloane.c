...
#include <sloane/cust_gpio_usage.h>
#include <sloane/cust_eint.h>

#include <linux/kernel.h>
#include <mach/upmu_hw.h>

#include "sloane/board-custom.h"
...
static struct cust_mt65xx_led cust_led_list[MT65XX_LED_TYPE_TOTAL] = {
	...
	{"isink",              MT65XX_LED_MODE_PMIC, -1, {0} },
	...
	{"lcd-backlight",      MT65XX_LED_MODE_NONE, -1, {1, 3, 1, 1, 0} },
#else
#if defined(CPT_CLAA101FP01_DSI_VDO)
	{"lcd-backlight", MT65XX_LED_MODE_NONE, -1, {0, 0x7F, 0, 0, 0} },
#else
	{"lcd-backlight", MT65XX_LED_MODE_NONE, -1, {0, 0x11, 0, 0, 0} },
#endif
#endif
};
