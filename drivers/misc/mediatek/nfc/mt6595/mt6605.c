...
static int mt6605_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	I2CDMAWriteBuf =
	    (char *)dma_alloc_coherent(NULL, MAX_BUFFER_SIZE, &I2CDMAWriteBuf_pa, GFP_KERNEL);
	...
	I2CDMAReadBuf =
	    (char *)dma_alloc_coherent(NULL, MAX_BUFFER_SIZE, &I2CDMAReadBuf_pa, GFP_KERNEL);
				...
				loff_t *offset)
{
	...
	do {
		...
		ret_tmp =
		    i2c_master_send(mt6605_dev->client, (unsigned char *)I2CDMAWriteBuf_pa, count);
