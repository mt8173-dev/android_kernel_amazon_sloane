...
int mtk_mem_bw_ctrl(int sce, int op)
{
	...
	if (highest != cur_con_sce) {
		...
		if (get_ddr_type() == LPDDR2) {
			mt65xx_reg_sync_writel(emi_arba_2xlpddr2_1066_val[highest], EMI_ARBA);
			/* mt65xx_reg_sync_writel(emi_arbb_2xlpddr2_1066_val[highest], EMI_ARBB); */
			mt65xx_reg_sync_writel(emi_arbc_2xlpddr2_1066_val[highest], EMI_ARBC);
			mt65xx_reg_sync_writel(emi_arbd_2xlpddr2_1066_val[highest], EMI_ARBD);
			mt65xx_reg_sync_writel(emi_arbe_2xlpddr2_1066_val[highest], EMI_ARBE);
			mt65xx_reg_sync_writel(emi_arbf_2xlpddr2_1066_val[highest], EMI_ARBF);
			mt65xx_reg_sync_writel(emi_arbg_2xlpddr2_1066_val[highest], EMI_ARBG);
		}
#if 0
			...
			mt65xx_reg_sync_writel(emi_arba_2xlpddr3_1600_val[highest], EMI_ARBA);
			/* mt65xx_reg_sync_writel(emi_arbb_2xlpddr3_1600_val[highest], EMI_ARBB); */
			mt65xx_reg_sync_writel(emi_arbc_2xlpddr3_1600_val[highest], EMI_ARBC);
			mt65xx_reg_sync_writel(emi_arbd_2xlpddr3_1600_val[highest], EMI_ARBD);
			mt65xx_reg_sync_writel(emi_arbe_2xlpddr3_1600_val[highest], EMI_ARBE);
			mt65xx_reg_sync_writel(emi_arbf_2xlpddr3_1600_val[highest], EMI_ARBF);
			mt65xx_reg_sync_writel(emi_arbg_2xlpddr3_1600_val[highest], EMI_ARBG);
		} else if (get_ddr_type() == LPDDR3_1866) {
			mt65xx_reg_sync_writel(emi_arba_lpddr3_1866_val[highest], EMI_ARBA);
			/* mt65xx_reg_sync_writel(emi_arbb_lpddr3_1866_val[highest], EMI_ARBB); */
			mt65xx_reg_sync_writel(emi_arbc_lpddr3_1866_val[highest], EMI_ARBC);
			mt65xx_reg_sync_writel(emi_arbd_lpddr3_1866_val[highest], EMI_ARBD);
			mt65xx_reg_sync_writel(emi_arbe_lpddr3_1866_val[highest], EMI_ARBE);
			mt65xx_reg_sync_writel(emi_arbf_lpddr3_1866_val[highest], EMI_ARBF);
			mt65xx_reg_sync_writel(emi_arbg_lpddr3_1866_val[highest], EMI_ARBG);
		}
#endif
		cur_con_sce = highest;
	}
...
static int __init emi_bwl_mod_init(void)
{
	...
	*/
	...
	/* Need emp_mpu to do initialization on emi ctrl, leave the setting until first scenario on */
