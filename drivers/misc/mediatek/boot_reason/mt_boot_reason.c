...
static const char boot_reason[][16] = { "keypad", "usb_chg", "rtc", "wdt", "reboot", "tool reboot", "smpl", "others", "kpanic" };
...
{
	pr_alert("boot_reason = %s(%d), state(%d,%d,%d)\n", boot_reason[g_boot_reason], g_boot_reason,
