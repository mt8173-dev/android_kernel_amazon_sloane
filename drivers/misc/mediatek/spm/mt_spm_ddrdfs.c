...
static void patch_fw_for_mempll_setting(struct pwr_ctrl *pwrctrl)
{
	...
	__flush_dcache_area((void *)ddrdfs_binary + FW_PATCH_START_INDEX,
...
return r;
	...
	__spm_kick_im_to_fetch(pcmdesc);	/* fetch firmware code */
