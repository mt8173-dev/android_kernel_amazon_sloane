...
#define MCDI_DVT_CPUxGPT 0	/* 0:disable, 1: enable : GPT need to modify mt_idle.c and mt_spm_mcdi.c */
 ...
 * PCM code for MCDI
 **********************************************************/
#if (MCDI_DVT_CPUxGPT) || (MCDI_DVT_IPI)	/* legacy sleep mode */
static const u32 mcdi_binary[] = {
	0x1212841f, 0xe2e00036, 0x1380201f, 0xe2e0003e, 0x1380201f, 0xe2e0003c,
	0x1380201f, 0xe2a00000, 0x1b80001f, 0x20000080, 0xe2e0002c, 0x1380201f,
	0xe2e0006c, 0xe2e0004c, 0x1b80001f, 0x20000020, 0xe2e0004d, 0xf0000000,
	0x17c07c1f, 0xe2e0004f, 0xe2e0006f, 0xe2e0002f, 0xe2a00001, 0x1b80001f,
	0x20000080, 0xe2e0002e, 0xe2e0003e, 0xe2e00032, 0xf0000000, 0x17c07c1f,
	...
	0x100062b4, 0x81142804, 0xd80005e4, 0x17c07c1f, 0xe2e0006e, 0xe2e0004e,
	0xe2e0004c, 0x1b80001f, 0x20000020, 0xe2e0004d, 0xf0000000, 0x17c07c1f,
	0xe2e0006d, 0xe2e0002d, 0x1a00001f, 0x100062b4, 0x1910001f, 0x100062b4,
	0xa1002804, 0xe2000004, 0xa1122804, 0xe2000004, 0x1b80001f, 0x20000080,
	0x1910001f, 0x100062b4, 0x81142804, 0xd8200904, 0x17c07c1f, 0xe2e0002f,
	0xe2e0003f, 0xe2e00033, 0xe2e00032, 0xf0000000, 0x17c07c1f, 0x17c07c1f,
	...
	0x17c07c1f, 0x1a40001f, 0x100062a0, 0x1280041f, 0xc2400780, 0x17c07c1f,
	...
	0x1a40001f, 0x100062a4, 0x1290841f, 0xc2400780, 0x17c07c1f, 0xa1528405,
	...
	0x100062a8, 0x1291041f, 0xc2400780, 0x17c07c1f, 0xa1530405, 0x1a10001f,
	...
	0x1291841f, 0xc2400780, 0x17c07c1f, 0xa1538405, 0x1b80001f, 0x20000208,
	...
	0x100062a0, 0x1280041f, 0xc24003c0, 0x17c07c1f, 0x89400005, 0xffffffef,
	...
	0x1a40001f, 0x100062a4, 0x1290841f, 0xc24003c0, 0x17c07c1f, 0x89400005,
	...
	0x17c07c1f, 0x1a40001f, 0x100062a8, 0x1291041f, 0xc24003c0, 0x17c07c1f,
	...
	0xd8007768, 0x17c07c1f, 0x1a40001f, 0x100062ac, 0x1291841f, 0xc24003c0,
...
static struct pcm_desc mcdi_pcm = {
	.version = "pcm_mcdi_v0.5_20140721_mt8173_v00.01_20141008",
	.base = mcdi_binary,
	.size = 982,
	.sess = 2,
	.replace = 0,
...
#if (MCDI_DVT_IPI)
	if (ret == 1) {
		printk("[MCDI] spm_read(SPM_SLEEP_WAKEUP_MISC)=0x%x\n",
...
bool spm_mcdi_can_enter(void)
{
	...
	if ((SPM_MCDI_isKICK == 0) || ((spm_read(SPM_SLEEP_CPU_WAKEUP_EVENT) & 0x1) == 1)
	    || ((spm_read(SPM_APMCU_PWRCTL) & 0x1) == 1) || (is_in_cpufreq == 1)
	    || (atomic_read(&is_in_hotplug) >= 1))
		ret = 0;

#if (MCDI_DVT_IPI || MCDI_DVT_CPUxGPT)
	if (ret == 0) {
		printk("[MCDI] SPM_MCDI_isKICK=%d\n", SPM_MCDI_isKICK);
		printk("[MCDI] is_in_cpufreq=%d\n", is_in_cpufreq);
		printk("[MCDI] spm_read(SPM_SLEEP_CPU_WAKEUP_EVENT)=%d\n",
		       spm_read(SPM_SLEEP_CPU_WAKEUP_EVENT));
		printk("[MCDI] spm_read(SPM_APMCU_PWRCTL)=%d\n", spm_read(SPM_APMCU_PWRCTL));
		printk("[MCDI] atomic_read(&is_in_hotplug)=%d\n", atomic_read(&is_in_hotplug));
	}
#endif
	...
	if ((spm_read(SPM_PCM_RESERVE) & (1 << mcdi_core_id)) == 0) {
		if (spm_is_cpu_irq_occur(mcdi_core_id) == 0) {
			...
			if (dmnt_ret == MT_CPU_DORMANT_RESET) {
				...
				while ((spm_read(SPM_SLEEP_ISR_STATUS) & (1 << (mcdi_core_id + 4)))
				       == 0) {
					spin_lock_irqsave(&__spm_lock, flags);
