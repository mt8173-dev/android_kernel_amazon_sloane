#ifndef _BATTERY_METER_CUSTOM_DATA_WRAP_H
#define _BATTERY_METER_CUSTOM_DATA_WRAP_H
...
#define RBAT_PULL_UP_R (p_bat_meter_data->rbat_pull_up_r)
#define RBAT_PULL_DOWN_R (p_bat_meter_data->rbat_pull_down_r)
#define RBAT_PULL_UP_VOLT (p_bat_meter_data->rbat_pull_up_volt)

#define Batt_Temperature_Table ((BATT_TEMPERATURE *)p_bat_meter_data->p_batt_temperature_table)
#define battery_profile_t0 ((BATTERY_PROFILE_STRUC *)p_bat_meter_data->p_battery_profile_t0)
#define battery_profile_t1 ((BATTERY_PROFILE_STRUC *)p_bat_meter_data->p_battery_profile_t1)
#define battery_profile_t2 ((BATTERY_PROFILE_STRUC *)p_bat_meter_data->p_battery_profile_t2)
#define battery_profile_t3 ((BATTERY_PROFILE_STRUC *)p_bat_meter_data->p_battery_profile_t3)
#define r_profile_t0 ((R_PROFILE_STRUC *)p_bat_meter_data->p_r_profile_t0)
#define r_profile_t1 ((R_PROFILE_STRUC *)p_bat_meter_data->p_r_profile_t1)
#define r_profile_t2 ((R_PROFILE_STRUC *)p_bat_meter_data->p_r_profile_t2)
#define r_profile_t3 ((R_PROFILE_STRUC *)p_bat_meter_data->p_r_profile_t3)
#define battery_profile_t0 ((BATTERY_PROFILE_STRUC *)p_bat_meter_data->p_battery_profile_t0)
#define battery_profile_temperature ((BATTERY_PROFILE_STRUC *)p_bat_meter_data->p_battery_profile_temperature)
#define r_profile_temperature ((R_PROFILE_STRUC *)p_bat_meter_data->p_r_profile_temperature)
#define battery_aging_table ((BATTERY_CYCLE_STRUC *)p_bat_meter_data->p_battery_aging_table)
...
#endif				/* #ifndef _BATTERY_METER_CUSTOM_DATA_WRAP_H */
