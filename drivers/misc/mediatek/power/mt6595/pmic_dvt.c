...
void PMIC_BUCK_ON_OFF(int index_val)
{
	...
	switch (index_val) {
		/* MT6331 */
	case 0:
		exec_vdvfs11_en_test();
		break;
	case 1:
		exec_vdvfs12_en_test();
		break;
	case 2:
		exec_vdvfs13_en_test();
		break;
	case 3:
		exec_vdvfs14_en_test();
		break;
	case 4:
		exec_vgpu_en_test();
		break;
...
void exec_vdvfs11_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VDVFS11_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vdvfs11_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS11_INDEX);
	}
	for (k = 0; k <= MT6331_PMIC_VDVFS11_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vdvfs11_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS11_INDEX);
	}
...
void exec_vdvfs11_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vdvfs11_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VDVFS11_VOSEL_MASK; k++) {
				...
				printk("[mt6331_upmu_set_vdvfs11_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VDVFS11_INDEX);
			}
...
void exec_vdvfs12_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VDVFS12_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vdvfs12_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS12_INDEX);
	}
	for (k = 0; k <= MT6331_PMIC_VDVFS12_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vdvfs12_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS12_INDEX);
	}
...
void exec_vdvfs12_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vdvfs12_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VDVFS12_VOSEL_MASK; k++) {
				...
				printk("[mt6331_upmu_set_vdvfs12_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VDVFS12_INDEX);
			}
...
void exec_vdvfs13_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VDVFS13_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vdvfs13_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS13_INDEX);
	}
	for (k = 0; k <= MT6331_PMIC_VDVFS13_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vdvfs13_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS13_INDEX);
	}
...
void exec_vdvfs13_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vdvfs13_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VDVFS13_VOSEL_MASK; k++) {
				...
				printk("[mt6331_upmu_set_vdvfs13_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VDVFS13_INDEX);
			}
...
void exec_vdvfs14_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VDVFS14_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vdvfs14_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS14_INDEX);
	}
	for (k = 0; k <= MT6331_PMIC_VDVFS14_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vdvfs14_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS14_INDEX);
	}
...
void exec_vdvfs14_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vdvfs14_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VDVFS14_VOSEL_MASK; k++) {
				...
				printk("[mt6331_upmu_set_vdvfs14_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VDVFS14_INDEX);
			}
...
void exec_vcore1_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VCORE1_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vcore1_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VCORE1_INDEX);
	}
	for (k = 0; k <= MT6331_PMIC_VCORE1_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vcore1_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VCORE1_INDEX);
	}
...
void exec_vcore1_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vcore1_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VCORE1_VOSEL_MASK; k++) {
				...
				printk("[mt6331_upmu_set_vcore1_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VCORE1_INDEX);
			}
...
void exec_vcore2_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VCORE2_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vcore2_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VCORE2_INDEX);
	}
	for (k = 0; k <= MT6331_PMIC_VCORE2_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vcore2_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VCORE2_INDEX);
	}
...
void exec_vcore2_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vcore2_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VCORE2_VOSEL_MASK; k++) {
				...
				printk("[mt6331_upmu_set_vcore2_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VCORE2_INDEX);
			}
...
void exec_vgpu_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VGPU_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vgpu_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VGPU_INDEX);
	}
	for (k = 0; k <= MT6331_PMIC_VGPU_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vgpu_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VGPU_INDEX);
	}
...
void exec_vgpu_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vgpu_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VGPU_VOSEL_MASK; k++) {
				...
				printk("[mt6331_upmu_set_vgpu_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VGPU_INDEX);
			}
...
void exec_vio18_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VIO18_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vio18_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VIO18_INDEX);
	}
	for (k = 0; k <= MT6331_PMIC_VIO18_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6331_upmu_set_vio18_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VIO18_INDEX);
	}
...
void exec_vio18_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vio18_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VIO18_VOSEL_MASK; k++) {
				...
				printk("[mt6331_upmu_set_vio18_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VIO18_INDEX);
			}
...
void exec_vdram_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VDRAM_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vdram_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDRAM_INDEX);
	}
	for (k = 0; k <= MT6332_PMIC_VDRAM_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vdram_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDRAM_INDEX);
	}
...
void exec_vdram_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vdram_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VDRAM_VOSEL_MASK; k++) {
				...
				printk("[mt6332_upmu_set_vdram_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VDRAM_INDEX);
			}
...
void exec_vdvfs2_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VDVFS2_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vdvfs2_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS2_INDEX);
	}
	...
	for (k = 0; k <= MT6332_PMIC_VDVFS2_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vdvfs2_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VDVFS2_INDEX);
	}
...
void exec_vdvfs2_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vdvfs2_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VDVFS2_VOSEL_MASK; k++) {
				...
				printk("[mt6332_upmu_set_vdvfs2_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VDVFS2_INDEX);
			}
...
void exec_vrf1_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VRF1_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vrf1_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VRF1_INDEX);
	}
	for (k = 0; k <= MT6332_PMIC_VRF1_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vrf1_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VRF1_INDEX);
	}
...
void exec_vrf1_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vrf1_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VRF1_VOSEL_MASK; k++) {
				...
				printk("[mt6332_upmu_set_vrf1_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VRF1_INDEX);
			}
...
void exec_vrf2_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VRF2_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vrf2_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VRF2_INDEX);
	}
	for (k = 0; k <= MT6332_PMIC_VRF2_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vrf2_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VRF2_INDEX);
	}
...
void exec_vrf2_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vrf2_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VRF2_VOSEL_MASK; k++) {
				...
				printk("[mt6332_upmu_set_vrf2_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VRF2_INDEX);
			}
...
void exec_vpa_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VPA_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vpa_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VPA_INDEX);
	}
	for (k = 0; k <= MT6332_PMIC_VPA_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vpa_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VPA_INDEX);
	}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VPA_VOSEL_MASK; k++) {
				...
				printk("[mt6332_upmu_set_vpa_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VPA_INDEX);
			}
...
void exec_vsbst_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VSBST_VOSEL_SLEEP_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vsbst_vosel_sleep] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VSBST_INDEX);
	}
	for (k = 0; k <= MT6332_PMIC_VSBST_VOSEL_ON_MASK; k++) {
		...
		printk("[mt6332_upmu_set_vsbst_vosel_on] k=%d, ", k);
		if (k == 0)
			mdelay(500);
		read_adc_value(VSBST_INDEX);
	}
...
void exec_vsbst_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vsbst_vosel_test_sub_vosel();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VSBST_VOSEL_MASK; k++) {
				...
				printk("[mt6332_upmu_set_vsbst_vosel] k=%d, ", k);
				if (k == 0)
					mdelay(500);
				read_adc_value(VSBST_INDEX);
			}
...
void PMIC_BUCK_VOSEL(int index_val)
{
	...
	case 0:
		mt6331_upmu_set_vdvfs11_en(1);
		exec_vdvfs11_vosel_test();
		break;
	case 1:
		mt6331_upmu_set_vdvfs12_en(1);
		exec_vdvfs12_vosel_test();
		break;
	case 2:
		mt6331_upmu_set_vdvfs13_en(1);
		exec_vdvfs13_vosel_test();
		break;
	case 3:
		mt6331_upmu_set_vdvfs14_en(1);
		exec_vdvfs14_vosel_test();
		break;
	case 4:
		mt6331_upmu_set_vgpu_en(1);
		exec_vgpu_vosel_test();
		break;
	case 5:
		mt6331_upmu_set_vcore1_en(1);
		exec_vcore1_vosel_test();
		break;
	case 6:
		mt6331_upmu_set_vcore2_en(1);
		exec_vcore2_vosel_test();
		break;
	case 7:
		mt6331_upmu_set_vio18_en(1);
		exec_vio18_vosel_test();
		break;

		/* MT6331 */
	case 8:
		mt6332_upmu_set_vdram_en(1);
		exec_vdram_vosel_test();
		break;
	case 9:
		mt6332_upmu_set_vdvfs2_en(1);
		exec_vdvfs2_vosel_test();
		break;
	case 10:
		mt6332_upmu_set_vrf1_en(1);
		exec_vrf1_vosel_test();
		break;
	case 11:
		mt6332_upmu_set_vrf2_en(1);
		exec_vrf2_vosel_test();
		break;
	case 12:
		mt6332_upmu_set_vpa_en(1);
		exec_vpa_vosel_test();
...
void exec_vgpu_dlc_test_sub_dlc(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VGPU_DLC_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vgpu_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
	...
	for (k = 0; k <= MT6331_PMIC_VGPU_DLC_ON_MASK; k++) {
		...
		printk
		    ("[exec_vgpu_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
		     k, k, mt6331_upmu_get_qi_vgpu_dlc(), mt6331_upmu_get_qi_vgpu_dlc_n());
	}
}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VGPU_DLC_MASK; k++) {
				...
				printk
				    ("[exec_vgpu_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
				     k, k, mt6331_upmu_get_qi_vgpu_dlc(),
				     mt6331_upmu_get_qi_vgpu_dlc_n());
			}
			break;
...
void exec_vcore1_dlc_test_sub_dlc(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VCORE1_DLC_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vcore1_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
	...
	for (k = 0; k <= MT6331_PMIC_VCORE1_DLC_ON_MASK; k++) {
		...
		printk
		    ("[exec_vcore1_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
		     k, k, mt6331_upmu_get_qi_vcore1_dlc(), mt6331_upmu_get_qi_vcore1_dlc_n());
	}
}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VCORE1_DLC_MASK; k++) {
				...
				printk
				    ("[exec_vcore1_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
				     k, k, mt6331_upmu_get_qi_vcore1_dlc(),
				     mt6331_upmu_get_qi_vcore1_dlc_n());
			}
			break;
...
void exec_vcore2_dlc_test_sub_dlc(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VCORE2_DLC_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vcore2_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
	...
	for (k = 0; k <= MT6331_PMIC_VCORE2_DLC_ON_MASK; k++) {
		...
		printk
		    ("[exec_vcore2_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
		     k, k, mt6331_upmu_get_qi_vcore2_dlc(), mt6331_upmu_get_qi_vcore2_dlc_n());
	}
}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VCORE2_DLC_MASK; k++) {
				...
				printk
				    ("[exec_vcore2_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
				     k, k, mt6331_upmu_get_qi_vcore2_dlc(),
				     mt6331_upmu_get_qi_vcore2_dlc_n());
			}
			break;
...
void exec_vio18_dlc_test_sub_dlc(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VIO18_DLC_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vio18_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
	...
	for (k = 0; k <= MT6331_PMIC_VIO18_DLC_ON_MASK; k++) {
		...
		printk
		    ("[exec_vio18_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
		     k, k, mt6331_upmu_get_qi_vio18_dlc(), mt6331_upmu_get_qi_vio18_dlc_n());
	}
}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6331_PMIC_VIO18_DLC_MASK; k++) {
				...
				printk
				    ("[exec_vio18_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
				     k, k, mt6331_upmu_get_qi_vio18_dlc(),
				     mt6331_upmu_get_qi_vio18_dlc_n());
			}
			break;
...
void exec_vdram_dlc_test_sub_dlc(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VDRAM_DLC_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vdram_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
	...
	for (k = 0; k <= MT6332_PMIC_VDRAM_DLC_ON_MASK; k++) {
		...
		printk
		    ("[exec_vdram_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
		     k, k, mt6332_upmu_get_qi_vdram_dlc(), mt6332_upmu_get_qi_vdram_dlc_n());
	}
}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VDRAM_DLC_MASK; k++) {
				...
				printk
				    ("[exec_vdram_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
				     k, k, mt6332_upmu_get_qi_vdram_dlc(),
				     mt6332_upmu_get_qi_vdram_dlc_n());
			}
			break;
...
void exec_vdvfs2_dlc_test_sub_dlc(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VDVFS2_DLC_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vdvfs2_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
	...
	for (k = 0; k <= MT6332_PMIC_VDVFS2_DLC_ON_MASK; k++) {
		...
		printk
		    ("[exec_vdvfs2_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
		     k, k, mt6332_upmu_get_qi_vdvfs2_dlc(), mt6332_upmu_get_qi_vdvfs2_dlc_n());
	}
}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VDVFS2_DLC_MASK; k++) {
				...
				printk
				    ("[exec_vdvfs2_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
				     k, k, mt6332_upmu_get_qi_vdvfs2_dlc(),
				     mt6332_upmu_get_qi_vdvfs2_dlc_n());
			}
			break;
...
void exec_vrf1_dlc_test_sub_dlc(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VRF1_DLC_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vrf1_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
	...
	for (k = 0; k <= MT6332_PMIC_VRF1_DLC_ON_MASK; k++) {
		...
		printk
		    ("[exec_vrf1_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
		     k, k, mt6332_upmu_get_qi_vrf1_dlc(), mt6332_upmu_get_qi_vrf1_dlc_n());
	}
}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VRF1_DLC_MASK; k++) {
				...
				printk
				    ("[exec_vrf1_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
				     k, k, mt6332_upmu_get_qi_vrf1_dlc(),
				     mt6332_upmu_get_qi_vrf1_dlc_n());
			}
			break;
...
void exec_vrf2_dlc_test_sub_dlc(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VRF2_DLC_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vrf2_dlc_test_sub_dlc] dlc_sleep=%d, dlc_n_sleep=%d, qi_dlc=%d, qi_dlc_n=%d\n",
	...
	for (k = 0; k <= MT6332_PMIC_VRF2_DLC_ON_MASK; k++) {
		...
		printk
		    ("[exec_vrf2_dlc_test_sub_dlc] dlc_on=%d, dlc_n_on=%d, qi_dlc=%d, qi_dlc_n=%d\n",
		     k, k, mt6332_upmu_get_qi_vrf2_dlc(), mt6332_upmu_get_qi_vrf2_dlc_n());
	}
}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VRF2_DLC_MASK; k++) {
				...
				printk
				    ("[exec_vrf2_dlc_test] dlc=%d, dlc_n=%d, qi_dlc=%d, qi_dlc_n=%d\n",
				     k, k, mt6332_upmu_get_qi_vrf2_dlc(),
				     mt6332_upmu_get_qi_vrf2_dlc_n());
			}
			break;
...
void PMIC_BUCK_DLC(int index_val)
{
	...
	switch (index_val) {
		/* MT6331 */
	case 0:
		printk("[PMIC_BUCK_DLC] no DLC function\n");
		break;
	case 1:
		printk("[PMIC_BUCK_DLC] no DLC function\n");
		break;
...
void exec_vgpu_burst_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vgpu_burst_test_sub_burst();
...
void exec_vcore1_burst_test_sub_burst(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VCORE1_BURST_SLEEP_MASK; k++) {
		...
		printk("[exec_vcore1_burst_test_sub_burst] burst_sleep=%d, qi_burst=%d\n", k,
		       mt6331_upmu_get_qi_vcore1_burst());
	}
...
void exec_vcore1_burst_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vcore1_burst_test_sub_burst();
...
void exec_vcore2_burst_test_sub_burst(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VCORE2_BURST_SLEEP_MASK; k++) {
		...
		printk("[exec_vcore2_burst_test_sub_burst] burst_sleep=%d, qi_burst=%d\n", k,
		       mt6331_upmu_get_qi_vcore2_burst());
	}
...
void exec_vcore2_burst_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vcore2_burst_test_sub_burst();
...
void exec_vio18_burst_test_sub_burst(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_VCORE2_BURST_SLEEP_MASK; k++) {
		...
		printk("[exec_vio18_burst_test_sub_burst] burst_sleep=%d, qi_burst=%d\n", k,
		       mt6331_upmu_get_qi_vio18_burst());
	}
...
void exec_vio18_burst_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vio18_burst_test_sub_burst();
...
void exec_vdram_burst_test_sub_burst(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VDRAM_BURST_SLEEP_MASK; k++) {
		...
		printk("[exec_vdram_burst_test_sub_burst] burst_sleep=%d, qi_burst=%d\n", k,
		       mt6332_upmu_get_qi_vdram_burst());
	}
...
void exec_vdram_burst_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vdram_burst_test_sub_burst();
...
void exec_vdvfs2_burst_test_sub_burst(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VDVFS2_BURST_SLEEP_MASK; k++) {
		...
		printk("[exec_vdvfs2_burst_test_sub_burst] burst_sleep=%d, qi_burst=%d\n", k,
		       mt6332_upmu_get_qi_vdvfs2_burst());
	}
...
void exec_vdvfs2_burst_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vdvfs2_burst_test_sub_burst();
...
void exec_vrf1_burst_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vrf1_burst_test_sub_burst();
...
void exec_vrf2_burst_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vrf2_burst_test_sub_burst();
...
void exec_vpa_burst_test_sub_burst(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VPA_BURSTH_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vpa_burst_test_sub_burst] bursth_sleep=%d, burstl_sleep=%d, qi_bursth=%d, qi_burstl=%d\n",
	...
	for (k = 0; k <= MT6332_PMIC_VPA_BURSTH_ON_MASK; k++) {
		...
		printk
		    ("[exec_vpa_burst_test_sub_burst] bursth_on=%d, burstl_on=%d, qi_bursth=%d, qi_burstl=%d\n",
		     k, k, mt6332_upmu_get_qi_vpa_bursth(), mt6332_upmu_get_qi_vpa_burstl());
	}
}
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VPA_BURSTH_MASK; k++) {
				...
				printk
				    ("[exec_vpa_burst_test] bursth=%d, burstl=%d, qi_bursth=%d, qi_burstl=%d\n",
				     k, k, mt6332_upmu_get_qi_vpa_bursth(),
				     mt6332_upmu_get_qi_vpa_burstl());
			}
			break;
...
void exec_vsbst_burst_test_sub_burst(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_VSBST_BURSTH_SLEEP_MASK; k++) {
		...
		printk
		    ("[exec_vsbst_burst_test_sub_burst] bursth_sleep=%d, burstl_sleep=%d, qi_bursth=%d, qi_burstl=%d\n",
	...
	for (k = 0; k <= MT6332_PMIC_VSBST_BURSTH_ON_MASK; k++) {
		...
		printk
		    ("[exec_vsbst_burst_test_sub_burst] bursth_on=%d, burstl_on=%d, qi_bursth=%d, qi_burstl=%d\n",
		     k, k, mt6332_upmu_get_qi_vsbst_bursth(), mt6332_upmu_get_qi_vsbst_burstl());
	}
}
...
void exec_vsbst_burst_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_vsbst_burst_test_sub_burst();
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			for (k = 0; k <= MT6332_PMIC_VSBST_BURSTH_MASK; k++) {
				...
				printk
				    ("[exec_vsbst_burst_test] bursth=%d, burstl=%d, qi_bursth=%d, qi_burstl=%d\n",
				     k, k, mt6332_upmu_get_qi_vsbst_bursth(),
				     mt6332_upmu_get_qi_vsbst_burstl());
			}
			break;
...
void PMIC_BUCK_BURST(int index_val)
{
	...
	switch (index_val) {
		/* MT6331 */
	case 0:
		printk("[PMIC_BUCK_BURST] no BURST function\n");
		break;
	case 1:
		printk("[PMIC_BUCK_BURST] no BURST function\n");
		break;
...
void exec_6331_ldo_vtcxo1_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VTCXO1, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VTCXO1]\n");
			hwPowerDown(MT6331_POWER_LDO_VTCXO1, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vtcxo1_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vtcxo2_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VTCXO2, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VTCXO2]\n");
			hwPowerDown(MT6331_POWER_LDO_VTCXO2, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vtcxo2_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vaud32_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VAUD32, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VAUD32]\n");
			hwPowerDown(MT6331_POWER_LDO_VAUD32, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vaud32_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vaud32_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vaud32_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vaud32_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vaud32_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vaud32_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vaud32_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vauxa32_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VAUXA32, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VAUXA32]\n");
			hwPowerDown(MT6331_POWER_LDO_VAUXA32, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vauxa32_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vauxa32_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vauxa32_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vauxa32_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vauxa32_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vauxa32_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vauxa32_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vcama_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMA, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VCAMA]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMA, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vio28_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VIO28, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VIO28]\n");
	hwPowerDown(MT6331_POWER_LDO_VIO28, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vcam_af_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_AF, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vmc_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VMC, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VMC]\n");
			hwPowerDown(MT6331_POWER_LDO_VMC, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vmc_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vmc_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vmc_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vmc_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vmc_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vmc_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vmc_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vmch_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VMCH, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VMCH]\n");
			hwPowerDown(MT6331_POWER_LDO_VMCH, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vmch_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vmch_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vmch_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vmch_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vmch_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vmch_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vmch_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vemc33_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VEMC33, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VEMC33]\n");
			hwPowerDown(MT6331_POWER_LDO_VEMC33, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vemc33_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vemc33_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vemc33_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vemc33_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vemc33_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vemc33_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vemc33_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vgp1_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP1, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vgp4_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vsim1_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VSIM1, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VSIM1]\n");
			hwPowerDown(MT6331_POWER_LDO_VSIM1, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vsim1_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vsim1_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vsim1_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vsim1_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vsim1_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vsim1_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vsim1_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vsim2_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VSIM2, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VSIM2]\n");
			hwPowerDown(MT6331_POWER_LDO_VSIM2, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vsim2_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vsim2_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vsim2_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vsim2_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vsim2_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vsim2_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vsim2_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vfbb_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VFBB, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VFBB]\n");
	hwPowerDown(MT6331_POWER_LDO_VFBB, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vibr_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
	hwPowerDown(MT6331_POWER_LDO_VIBR, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vrtc_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VRTC, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VRTC]\n");
	hwPowerDown(MT6331_POWER_LDO_VRTC, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vmipi_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
			hwPowerDown(MT6331_POWER_LDO_VMIPI, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vmipi_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vmipi_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vmipi_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vmipi_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vmipi_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vmipi_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vmipi_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vcamd_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMD, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VCAMD]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMD, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vusb10_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VUSB10]\n");
	hwPowerDown(MT6331_POWER_LDO_VUSB10, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vcam_io_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_IO, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_IO]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_IO, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vsram_dvfs1_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6331_POWER_LDO_VSRAM_DVFS1, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6331_POWER_LDO_VSRAM_DVFS1]\n");
			hwPowerDown(MT6331_POWER_LDO_VSRAM_DVFS1, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(1)]\n");
			mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(2)]\n");
			mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(3)]\n");
			mt6331_upmu_set_rg_vsram_dvfs1_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vgp2_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VGP2, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VGP2]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP2, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vgp3_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VGP3, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VGP3]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP3, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vbiasn_en_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VBIASN, VOL_0500, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6331_POWER_LDO_VBIASN]\n");
	hwPowerDown(MT6331_POWER_LDO_VBIASN, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6332_ldo_vauxb32_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6332_POWER_LDO_VAUXB32, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6332_POWER_LDO_VAUXB32]\n");
			hwPowerDown(MT6332_POWER_LDO_VAUXB32, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6332_upmu_set_rg_vauxb32_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6332_upmu_set_rg_vauxb32_srclk_en_sel(1)]\n");
			mt6332_upmu_set_rg_vauxb32_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6332_upmu_set_rg_vauxb32_srclk_en_sel(2)]\n");
			mt6332_upmu_set_rg_vauxb32_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6332_upmu_set_rg_vauxb32_srclk_en_sel(3)]\n");
			mt6332_upmu_set_rg_vauxb32_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6332_ldo_vbif28_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6332_POWER_LDO_VBIF28, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6332_POWER_LDO_VBIF28]\n");
			hwPowerDown(MT6332_POWER_LDO_VBIF28, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6332_upmu_set_rg_vbif28_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6332_upmu_set_rg_vbif28_srclk_en_sel(1)]\n");
			mt6332_upmu_set_rg_vbif28_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6332_upmu_set_rg_vbif28_srclk_en_sel(2)]\n");
			mt6332_upmu_set_rg_vbif28_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6332_upmu_set_rg_vbif28_srclk_en_sel(3)]\n");
			mt6332_upmu_set_rg_vbif28_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6332_ldo_vusb33_en_test(void)
{
	...
	hwPowerOn(MT6332_POWER_LDO_VUSB33, VOL_DEFAULT, "ldo_dvt");
	read_adc_value(LDO_ONLY);

	printk("hwPowerDown(MT6332_POWER_LDO_VUSB33]\n");
	hwPowerDown(MT6332_POWER_LDO_VUSB33, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6332_ldo_vsram_dvfs2_en_test(void)
{
	...
	for (i = 0; i <= 1; i++) {
		...
		case 0:
			...
			hwPowerOn(MT6332_POWER_LDO_VSRAM_DVFS2, VOL_DEFAULT, "ldo_dvt");
			read_adc_value(LDO_ONLY);

			printk("hwPowerDown(MT6332_POWER_LDO_VSRAM_DVFS2]\n");
			hwPowerDown(MT6332_POWER_LDO_VSRAM_DVFS2, "ldo_dvt");
			read_adc_value(LDO_ONLY);
		...
		case 1:
			...
			mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(0);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(1)]\n");
			mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(1);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(2)]\n");
			mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(2);
			exec_scrxxx_map(LDO_ONLY);

			printk("[mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(3)]\n");
			mt6332_upmu_set_rg_vsram_dvfs2_srclk_en_sel(3);
			exec_scrxxx_map(LDO_ONLY);
			break;
...
void exec_6331_ldo_vaud32_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VAUD32, VOL_2800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VAUD32]\n");
	hwPowerDown(MT6331_POWER_LDO_VAUD32, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VAUD32, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VAUD32]\n");
	hwPowerDown(MT6331_POWER_LDO_VAUD32, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VAUD32, VOL_3200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VAUD32]\n");
	hwPowerDown(MT6331_POWER_LDO_VAUD32, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vauxa32_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VAUXA32, VOL_2800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VAUXA32]\n");
	hwPowerDown(MT6331_POWER_LDO_VAUXA32, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VAUXA32, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VAUXA32]\n");
	hwPowerDown(MT6331_POWER_LDO_VAUXA32, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VAUXA32, VOL_3200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VAUXA32]\n");
	hwPowerDown(MT6331_POWER_LDO_VAUXA32, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vcama_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMA, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMA]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMA, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMA, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMA]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMA, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMA, VOL_2500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMA]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMA, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMA, VOL_2800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMA]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMA, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vcam_af_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_AF, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_AF, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_AF, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_AF, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_2000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_AF, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_2800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_AF, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_AF, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_AF, VOL_3300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_AF]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_AF, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vmc_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VMC, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMC]\n");
	hwPowerDown(MT6331_POWER_LDO_VMC, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VMC, VOL_3300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMC]\n");
	hwPowerDown(MT6331_POWER_LDO_VMC, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vmch_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VMCH, VOL_3000, "ldo_dvt");
	read_adc_value(LDO_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMCH]\n");
	hwPowerDown(MT6331_POWER_LDO_VMCH, "ldo_dvt");
	read_adc_value(LDO_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VMCH, VOL_3300, "ldo_dvt");
	read_adc_value(LDO_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMCH]\n");
	hwPowerDown(MT6331_POWER_LDO_VMCH, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vemc33_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VEMC33, VOL_3000, "ldo_dvt");
	read_adc_value(LDO_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VEMC33]\n");
	hwPowerDown(MT6331_POWER_LDO_VEMC33, "ldo_dvt");
	read_adc_value(LDO_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VEMC33, VOL_3300, "ldo_dvt");
	read_adc_value(LDO_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VEMC33]\n");
	hwPowerDown(MT6331_POWER_LDO_VEMC33, "ldo_dvt");
	read_adc_value(LDO_ONLY);
...
void exec_6331_ldo_vgp1_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_2000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_2800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP1, VOL_3300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP1]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vgp4_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_2000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_2800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP4, VOL_3300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP4]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP4, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vsim1_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VSIM1, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VSIM1]\n");
	hwPowerDown(MT6331_POWER_LDO_VSIM1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VSIM1, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VSIM1]\n");
	hwPowerDown(MT6331_POWER_LDO_VSIM1, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vsim2_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VSIM2, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VSIM2]\n");
	hwPowerDown(MT6331_POWER_LDO_VSIM2, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VSIM2, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VSIM2]\n");
	hwPowerDown(MT6331_POWER_LDO_VSIM2, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vibr_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
	hwPowerDown(MT6331_POWER_LDO_VIBR, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
	hwPowerDown(MT6331_POWER_LDO_VIBR, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
	hwPowerDown(MT6331_POWER_LDO_VIBR, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
	hwPowerDown(MT6331_POWER_LDO_VIBR, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_2000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
	hwPowerDown(MT6331_POWER_LDO_VIBR, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_2800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
	hwPowerDown(MT6331_POWER_LDO_VIBR, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
	hwPowerDown(MT6331_POWER_LDO_VIBR, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VIBR, VOL_3300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VIBR]\n");
	hwPowerDown(MT6331_POWER_LDO_VIBR, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_vdig18_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6331_PMIC_RG_VDIG18_VOSEL_MASK; k++) {
		...
		printk("[mt6331_upmu_set_rg_vdig18_vosel] k=%d, ", k);
		read_adc_value(LDO_ONLY);
	}
	for (k = 0; k <= MT6331_PMIC_RG_VDIG18_SLEEP_VOSEL_MASK; k++) {
		mt6331_upmu_set_rg_vdig18_sleep_vosel(k);
		printk("[mt6331_upmu_set_rg_vdig18_sleep_vosel] k=%d, ", k);
		read_adc_value(LDO_ONLY);
	}
}
...
void exec_6331_vdig18_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_6331_vdig18_vosel_test_sub_vosel();
...
void exec_6331_ldo_vdig18_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VDIG18, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6331_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6331_POWER_LDO_VDIG18] VOL_1300\n");
	hwPowerOn(MT6331_POWER_LDO_VDIG18, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6331_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6331_POWER_LDO_VDIG18] VOL_1400\n");
	hwPowerOn(MT6331_POWER_LDO_VDIG18, VOL_1400, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6331_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6331_POWER_LDO_VDIG18] VOL_1500\n");
	hwPowerOn(MT6331_POWER_LDO_VDIG18, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6331_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6331_POWER_LDO_VDIG18] VOL_1600\n");
	hwPowerOn(MT6331_POWER_LDO_VDIG18, VOL_1600, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6331_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6331_POWER_LDO_VDIG18] VOL_1700\n");
	hwPowerOn(MT6331_POWER_LDO_VDIG18, VOL_1700, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6331_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6331_POWER_LDO_VDIG18] VOL_1800\n");
	hwPowerOn(MT6331_POWER_LDO_VDIG18, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6331_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vmipi_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
	hwPowerDown(MT6331_POWER_LDO_VMIPI, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
	hwPowerDown(MT6331_POWER_LDO_VMIPI, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
	hwPowerDown(MT6331_POWER_LDO_VMIPI, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
	hwPowerDown(MT6331_POWER_LDO_VMIPI, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_2000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
	hwPowerDown(MT6331_POWER_LDO_VMIPI, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_2800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
	hwPowerDown(MT6331_POWER_LDO_VMIPI, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
	hwPowerDown(MT6331_POWER_LDO_VMIPI, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VMIPI, VOL_3300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VMIPI]\n");
	hwPowerDown(MT6331_POWER_LDO_VMIPI, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vcamd_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMD, VOL_0900, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMD]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMD, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMD, VOL_1000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMD]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMD, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMD, VOL_1100, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMD]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMD, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMD, VOL_1220, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMD]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMD, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMD, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMD]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMD, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAMD, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAMD]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAMD, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vusb10_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_1000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VUSB10]\n");
	hwPowerDown(MT6331_POWER_LDO_VUSB10, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_1050, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VUSB10]\n");
	hwPowerDown(MT6331_POWER_LDO_VUSB10, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_1100, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VUSB10]\n");
	hwPowerDown(MT6331_POWER_LDO_VUSB10, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_1150, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VUSB10]\n");
	hwPowerDown(MT6331_POWER_LDO_VUSB10, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VUSB10]\n");
	hwPowerDown(MT6331_POWER_LDO_VUSB10, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_1250, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VUSB10]\n");
	hwPowerDown(MT6331_POWER_LDO_VUSB10, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VUSB10, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VUSB10]\n");
	hwPowerDown(MT6331_POWER_LDO_VUSB10, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vcam_io_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_IO, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_IO]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_IO, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_IO, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_IO]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_IO, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_IO, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_IO]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_IO, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VCAM_IO, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VCAM_IO]\n");
	hwPowerDown(MT6331_POWER_LDO_VCAM_IO, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vgp2_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VGP2, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP2]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP2, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP2, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP2]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP2, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP2, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP2]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP2, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP2, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP2]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP2, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6331_ldo_vgp3_vosel_test(void)
{
	...
	hwPowerOn(MT6331_POWER_LDO_VGP3, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP3]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP3, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP3, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP3]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP3, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP3, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP3]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP3, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6331_POWER_LDO_VGP3, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6331_POWER_LDO_VGP3]\n");
	hwPowerDown(MT6331_POWER_LDO_VGP3, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6332_ldo_vauxb32_vosel_test(void)
{
	...
	hwPowerOn(MT6332_POWER_LDO_VAUXB32, VOL_2800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VAUXB32]\n");
	hwPowerDown(MT6332_POWER_LDO_VAUXB32, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6332_POWER_LDO_VAUXB32, VOL_3000, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VAUXB32]\n");
	hwPowerDown(MT6332_POWER_LDO_VAUXB32, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	...
	hwPowerOn(MT6332_POWER_LDO_VAUXB32, VOL_3200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VAUXB32]\n");
	hwPowerDown(MT6332_POWER_LDO_VAUXB32, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void exec_6332_vdig18_vosel_test_sub_vosel(void)
{
	...
	for (k = 0; k <= MT6332_PMIC_RG_VDIG18_VOSEL_MASK; k++) {
		...
		printk("[mt6332_upmu_set_rg_vdig18_vosel] k=%d, ", k);
		read_adc_value(LDO_ONLY);
	}
	for (k = 0; k <= MT6332_PMIC_RG_VDIG18_SLEEP_VOSEL_MASK; k++) {
		mt6332_upmu_set_rg_vdig18_sleep_vosel(k);
		printk("[mt6332_upmu_set_rg_vdig18_sleep_vosel] k=%d, ", k);
		read_adc_value(LDO_ONLY);
	}
}
...
void exec_6332_vdig18_vosel_test_sub(void)
{
	...
	set_srclken_1_val(0);
	set_srclken_2_val(0);
	exec_6332_vdig18_vosel_test_sub_vosel();
...
void exec_6332_ldo_vdig18_vosel_test(void)
{
	...
	hwPowerOn(MT6332_POWER_LDO_VDIG18, VOL_1200, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6332_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6332_POWER_LDO_VDIG18] VOL_1300\n");
	hwPowerOn(MT6332_POWER_LDO_VDIG18, VOL_1300, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6332_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6332_POWER_LDO_VDIG18] VOL_1400\n");
	hwPowerOn(MT6332_POWER_LDO_VDIG18, VOL_1400, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6332_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6332_POWER_LDO_VDIG18] VOL_1500\n");
	hwPowerOn(MT6332_POWER_LDO_VDIG18, VOL_1500, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6332_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6332_POWER_LDO_VDIG18] VOL_1600\n");
	hwPowerOn(MT6332_POWER_LDO_VDIG18, VOL_1600, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6332_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6332_POWER_LDO_VDIG18] VOL_1700\n");
	hwPowerOn(MT6332_POWER_LDO_VDIG18, VOL_1700, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6332_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerOn(MT6332_POWER_LDO_VDIG18] VOL_1800\n");
	hwPowerOn(MT6332_POWER_LDO_VDIG18, VOL_1800, "ldo_dvt");
	read_adc_value(ADC_ONLY);
	printk("hwPowerDown(MT6332_POWER_LDO_VDIG18]\n");
	hwPowerDown(MT6332_POWER_LDO_VDIG18, "ldo_dvt");
	read_adc_value(ADC_ONLY);
...
void set_bif_cmd(int bif_cmd[], int bif_cmd_len)
{
	...
	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC",
		    ...
		    MT6332_BIF_CON0, upmu_get_reg_value(MT6332_BIF_CON0), MT6332_BIF_CON1,
		    upmu_get_reg_value(MT6332_BIF_CON1), MT6332_BIF_CON2,
		    upmu_get_reg_value(MT6332_BIF_CON2), MT6332_BIF_CON3,
		    upmu_get_reg_value(MT6332_BIF_CON3), MT6332_BIF_CON4,
		    upmu_get_reg_value(MT6332_BIF_CON4), MT6332_BIF_CON5,
		    upmu_get_reg_value(MT6332_BIF_CON5), MT6332_BIF_CON6,
		    upmu_get_reg_value(MT6332_BIF_CON6), MT6332_BIF_CON7,
		    upmu_get_reg_value(MT6332_BIF_CON7), MT6332_BIF_CON8,
		    upmu_get_reg_value(MT6332_BIF_CON8), MT6332_BIF_CON9,
		    upmu_get_reg_value(MT6332_BIF_CON9), MT6332_BIF_CON10,
		    upmu_get_reg_value(MT6332_BIF_CON10), MT6332_BIF_CON11,
		    upmu_get_reg_value(MT6332_BIF_CON11)
	    );
}
...
void check_bat_lost(void)
{
	...
	printk
	    ("[check_bat_lost] BIF_BAT_LOST : BIF_CON31[13]=0x%x - battery is detected(0)/battery is undetected(1)\n",
	     reg_val);
}
...
void bif_debug(void)
{
	...
	printk
	    ("[bif_debug] qi_bif_tx_en, qi_bif_tx_data, qi_bif_rx_en, qi_bif_rx_data, bif_tx_state, bif_flow_ctl_state, bif_rx_state, bif_data_num, rgs_baton_ht\n");
	...
	for (i = 0; i < repeat; i++) {
		...
		printk("[bif_debug] %d,%d,%d,%d,%d,%d,%d,%d,%d\n",
		       qi_bif_tx_en, qi_bif_tx_data, qi_bif_rx_en, qi_bif_rx_data, bif_tx_state,
		       bif_flow_ctl_state, bif_rx_state, bif_data_num, rgs_baton_ht);
	}
}
...
void tc_bif_1003_step_5(void)
{
	...
	ret = pmic_read_interface(MT6332_BIF_CON31, &reg_val, 0x1, 13);
	printk
	    ("[tc_bif_1003_step_5] BIF_BAT_LOST : BIF_CON31[13]=0x%x - battery is detected(0)/battery is undetected(1)\n",
	     reg_val);
...
void tc_bif_1003_step_5_positive(void)
{
	...
	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC",
		    "Reg[0x%x]=0x%x,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n",
		    MT6332_BIF_CON15, upmu_get_reg_value(MT6332_BIF_CON15), MT6332_BIF_CON17,
		    upmu_get_reg_value(MT6332_BIF_CON17), MT6332_BIF_CON30,
		    upmu_get_reg_value(MT6332_BIF_CON30), MT6332_BIF_CON37,
		    upmu_get_reg_value(MT6332_BIF_CON37)
	    );
	...
	ret = pmic_read_interface(MT6332_BIF_CON31, &reg_val, 0x1, 13);
	printk
	    ("[tc_bif_1003_step_5_positive] BIF_BAT_LOST : BIF_CON31[13]=0x%x - battery is detected(0)/battery is undetected(1)\n",
	     reg_val);
	ret = pmic_read_interface(MT6332_BIF_CON31, &reg_val, 0x1, 12);
	printk
	    ("[tc_bif_1003_step_5_positive] BIF_TIMEOUT : BIF_CON31[12]=0x%x - positive(0)/negative(1)\n",
	     reg_val);
	ret = pmic_read_interface(MT6332_BIF_CON19, &reg_val, 0x1, 12);
	printk
	    ("[tc_bif_1003_step_5_positive] BIF_RESPONSE : BIF_CON19[12]=0x%x - positive(1)/negative(0)\n",
	     reg_val);
...
void tc_bif_1003_step_5_negative(void)
{
	...
	ret = pmic_read_interface(MT6332_BIF_CON31, &reg_val, 0x1, 13);
	printk
	    ("[tc_bif_1003_step_5_negative] BIF_BAT_LOST : BIF_CON31[13]=0x%x - battery is detected(0)/battery is undetected(1)\n",
	     reg_val);
	ret = pmic_read_interface(MT6332_BIF_CON31, &reg_val, 0x1, 12);
	printk
	    ("[tc_bif_1003_step_5_negative] BIF_TIMEOUT : BIF_CON31[12]=0x%x - positive(0)/negative(1)\n",
	     reg_val);
	ret = pmic_read_interface(MT6332_BIF_CON19, &reg_val, 0x1, 12);
	printk
	    ("[tc_bif_1003_step_5_negative] BIF_RESPONSE : BIF_CON19[12]=0x%x - positive(1)/negative(0)\n",
	     reg_val);
...
void tc_bif_1004_step_1_positive(void)
{
	...
	ret = pmic_read_interface(MT6332_BIF_CON31, &reg_val, 0x1, 13);
	printk
	    ("[tc_bif_1004_step_1_positive] BIF_BAT_LOST : BIF_CON31[13]=0x%x - battery is detected(0)/battery is undetected(1)\n",
	     reg_val);
	ret = pmic_read_interface(MT6332_BIF_CON31, &reg_val, 0x1, 12);
	printk
	    ("[tc_bif_1004_step_1_positive] BIF_TIMEOUT : BIF_CON31[12]=0x%x - positive(0)/negative(1)\n",
	     reg_val);
	ret = pmic_read_interface(MT6332_BIF_CON19, &reg_val, 0x1, 12);
	printk
	    ("[tc_bif_1004_step_1_positive] BIF_RESPONSE : BIF_CON19[12]=0x%x - positive(1)/negative(0)\n",
	     reg_val);
...
void tc_bif_1004_step_1_negative(void)
{
	...
	ret = pmic_read_interface(MT6332_BIF_CON31, &reg_val, 0x1, 13);
	printk
	    ("[tc_bif_1004_step_1_negative] BIF_BAT_LOST : BIF_CON31[13]=0x%x - battery is detected(0)/battery is undetected(1)\n",
	     reg_val);
	ret = pmic_read_interface(MT6332_BIF_CON31, &reg_val, 0x1, 12);
	printk
	    ("[tc_bif_1004_step_1_negative] BIF_TIMEOUT : BIF_CON31[12]=0x%x - positive(0)/negative(1)\n",
	     reg_val);
	ret = pmic_read_interface(MT6332_BIF_CON19, &reg_val, 0x1, 12);
	printk
	    ("[tc_bif_1004_step_1_negative] BIF_RESPONSE : BIF_CON19[12]=0x%x - positive(1)/negative(0)\n",
	     reg_val);
...
void tc_bif_1003(void)
{
	...
	pmic_config_interface(MT6332_TOP_CKSEL_CON0, 0x4, MT6332_PMIC_RG_BIF_X4_CK_DIVSEL_MASK,
			      MT6332_PMIC_RG_BIF_X4_CK_DIVSEL_SHIFT);
	printk("[RG_BIF_X4_CK_DIVSEL] set done. Reg[0x%x]=0x%x\n", MT6332_TOP_CKSEL_CON0,
	       upmu_get_reg_value(MT6332_TOP_CKSEL_CON0)
	    );
...
static kal_uint32 mt6331_aPMURegDef[569][2] = {	/* Register , reset val */
	...
	{0x0100, 0x3110}, /*HWCID*/ {0x0102, 0x3110}, /*SWCID*/ {0x0104, 0x0000},	/*EXT_PMIC_STATUS */
	...
	{0x011C, 0x0000}, /*PGSTATUS*/ {0x011E, 0x0000}, /*TOPSTATUS*/ {0x0120, 0x0000},	/*TDSEL_CON */
...
static kal_uint32 mt6331_aPMURegDef_mask[569] = {	/* mask */
	...
	0xFFFF,			/*STRUP_CON17 */
	0x8000,			/*STRUP_CON18 */
	0xFFFF, /*HWCID*/ 0xFFFF, /*SWCID*/ 0x8000,	/*EXT_PMIC_STATUS */
	0x0377,			/*TOP_CON */
	0x0000,			/*TEST_OUT */
	0x0FFF,			/*TEST_CON0 */
	0x000F,			/*TEST_CON1 */
	...
	0x0000,			/*OCSTATUS1 */
	0x0000,			/*OCSTATUS2 */
	0x0000, /*PGSTATUS*/ 0x0F00, /*TOPSTATUS*/ 0x0007,	/*TDSEL_CON */
	0x0007,			/*RDSEL_CON */
	0x003F,			/*SMT_CON0 */
	0x000F,			/*SMT_CON1 */
	0x001F,			/*SMT_CON2 */
...
void top_6331_read(void)
{
	...
	for (u2Cnt = 0; u2Cnt < (sizeof(mt6331_aPMURegDef) / sizeof(*mt6331_aPMURegDef)); ++u2Cnt) {
		...
		default_value_mask =
		    ((mt6331_aPMURegDef[u2Cnt][1]) & mt6331_aPMURegDef_mask[u2Cnt]);
...
void top_6332_read(void)
{
	...
	for (u2Cnt = 0; u2Cnt < (sizeof(mt6332_aPMURegDef) / sizeof(*mt6332_aPMURegDef)); ++u2Cnt) {
		...
		default_value_mask =
		    ((mt6332_aPMURegDef[u2Cnt][1]) & mt6332_aPMURegDef_mask[u2Cnt]);
...
void exec_6331_efuse_test(void)
{
	...
	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC",
		    ...
		    upmu_get_reg_value(0x0150), 0x0144, upmu_get_reg_value(0x0144), 0x0616,
		    upmu_get_reg_value(0x0616)
	    );
	...
	for (i = 0; i <= 0x1F; i++) {
		...
		/* 6. read data */
		xlog_printk(ANDROID_LOG_INFO, "Power/PMIC",
			    "i=%d,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n", i, 0x0600,
			    upmu_get_reg_value(0x0600), 0x061A, upmu_get_reg_value(0x061A), 0x0618,
			    upmu_get_reg_value(0x0618)
		    );
	}
...
void exec_6332_efuse_test(void)
{
	...
	xlog_printk(ANDROID_LOG_INFO, "Power/PMIC",
		    "Reg[0x%x]=0x%x,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n", 0x80B2,
		    upmu_get_reg_value(0x80B2), 0x80A0, upmu_get_reg_value(0x80A0), 0x8C6C,
		    upmu_get_reg_value(0x8C6C)
	    );
	...
	for (i = 0; i <= 0x1F; i++) {
		...
		xlog_printk(ANDROID_LOG_INFO, "Power/PMIC",
			    "i=%d,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x,Reg[0x%x]=0x%x\n", i, 0x8C56,
			    upmu_get_reg_value(0x8C56), 0x8C70, upmu_get_reg_value(0x8C70), 0x8C6E,
			    upmu_get_reg_value(0x8C6E)
		    );
	}
...
extern kal_uint32 pmic_is_auxadc_ready(kal_int32 channel_num, upmu_adc_chip_list_enum chip_num,
				       upmu_adc_user_list_enum user_num);
extern kal_uint32 pmic_get_adc_output(kal_int32 channel_num, upmu_adc_chip_list_enum chip_num,
				      upmu_adc_user_list_enum user_num);
...
{
	int i, j;
	int ret[MAX_CHANNEL_NUM] = { 0 }, ret_raw[MAX_CHANNEL_NUM] = {
	0};
...
void do_auxadc_polling(int number, int chip_info, int user_info, int *channel_num,
		       upmu_adc_chip_list_enum *chip_num, upmu_adc_user_list_enum *user_num)
{
	...
	do {
		for (i = 0; i < MAX_CHANNEL_NUM; i++) {
			if (chip_num[i] != chip_info || (((0x1 << user_num[i]) & (user_info)) == 0))
				continue;
			if (ret_order[i] == 0
			    && pmic_is_auxadc_ready(channel_num[i], chip_num[i],
						    user_num[i]) == 1) {
				ret_data[i] =
				    pmic_get_adc_output(channel_num[i], chip_num[i], user_num[i]);
				ret_order[i] = order;
				order++;
			}
		}
	...
	printk("[%d][%d][%d][%d][%d][%d][%d][%d][%d][%d][%d]\n ",
	       ...
	       upmu_get_rg_adc_rdy_ch5(), upmu_get_rg_adc_rdy_gps(), upmu_get_rg_adc_rdy_md());
#endif
}
...
void auxadc_priority_test_GPSMD3_6331(void)
{
	...
	if (pmic_is_auxadc_ready(8, 0, 2)) {
		ret =
		    pmic_config_interface((kal_uint32) (MT6331_AUXADC_RQST1_SET), 0x0080, 0x0080,
					  0);
...
void auxadc_battery_int_protection_6331(U32 test_type, U32 test_mode)
{
	...
	while (!mt6331_upmu_get_auxadc_adc_rdy_lbat()) {
		...
		timeout_count++;
		printk
		    ("[auxadc_battery_int_protection_6331] wait for lbat ready! timeout_count = (%d)\n",
		     timeout_count);
	...
	printk
	    ("[auxadc_battery_int_protection_6331] setting .. done (adc_out_lbat=%d, lbat_debounce_count_max=%d, lbat_debounce_count_min=%d)\n",
...
void auxadc_battery_int_protection_6332(U32 test_type, U32 test_mode)
{
	...
	while (!mt6332_upmu_get_auxadc_adc_rdy_lbat()) {
		...
		timeout_count++;
		printk
		    ("[auxadc_battery_int_protection_6332] wait for lbat ready! timeout_count = (%d)\n",
		     timeout_count);
		if (timeout_count > 10000)
			break;
	}
	...
	/* 9. Test on VBAT = 4.0 -> 4.2 -> 4.3 and receive interrupt  -- HBAT_TEST */
	printk
	    ("[auxadc_battery_int_protection_6332] setting .. done (adc_out_lbat=%d, lbat_debounce_count_max=%d, lbat_debounce_count_min=%d)\n",
	     adc_out_lbat, lbat_debounce_count_max, lbat_debounce_count_min);
	if (test_mode == SLEEP_MODE) {
		printk("[auxadc_battery_int_protection_6332] sleep mode\n");
		/* 0.0 wakeup start setting for sleep mode */
...
void auxadc_thermal_int_protection_6331(U32 test_type, U32 test_mode)
{
	...
	while (!mt6331_upmu_get_auxadc_adc_rdy_thr_hw()) {
		timeout_count++;
		printk
		    ("[auxadc_thermal_int_protection_6331] wait for lbat ready! timeout_count = (%d)\n",
		     timeout_count);
		if (timeout_count > 10000)
			break;
	}
	...
	/* 9. Test on VBAT = 4.0 -> 4.2 -> 4.3 and receive interrupt  -- HBAT_TEST */
	printk
	    ("[auxadc_thermal_int_protection_6331] done (adc_out_thr=%d, thr_debounce_count_max=%d, thr_debounce_count_min=%d)\n",
...
void auxadc_thermal_int_protection_6332(U32 test_type, U32 test_mode)
{
	...
	while (!mt6332_upmu_get_auxadc_adc_rdy_thr_hw()) {
		timeout_count++;
		printk
		    ("[auxadc_thermal_int_protection_6332] wait for lbat ready! timeout_count = (%d)\n",
		     timeout_count);
		if (timeout_count > 10000)
			break;
	}
	...
	printk
	    ("[auxadc_thermal_int_protection_6332] done (adc_out_thr=%d, thr_debounce_count_max=%d, thr_debounce_count_min=%d)\n",
	     adc_out_thr, thr_debounce_count_max, thr_debounce_count_min);
...
void auxadc_swctrl_measure_test_6331(void)
{
	...
	for (i = 0; i < MAX_CHANNEL_NUM; i++) {
		...
		printk
		    ("[auxadc_swctrl_measure_test_6331] adc info: channel_num= %d, chip_num = %d\n",
...
void auxadc_swctrl_measure_test_6332(void)
{
	...
	for (i = 0; i < MAX_CHANNEL_NUM; i++) {
		...
		/* user_num[i] = PMIC_IMM_GetUserNumber(eChannelEnumList[i]); */
		printk
		    ("[auxadc_swctrl_measure_test_6332] adc info: channel_num= %d, chip_num = %d\n",
		     channel_num[i], chip_num[i]);
...
void pmic_dvt_entry(int test_id)
{
	...
	case 1:
		...
		break;
	case 2:
		top_6331_write(0x5a5a);
		break;
	case 3:
		top_6331_write(0xa5a5);
		break;
	case 4:
		top_6332_read();
		break;
	case 5:
		top_6332_write(0x5a5a);
		break;
	case 6:
		top_6332_write(0xa5a5);
		break;
	...
	case 1008:
		...
		/* BUCK */
	case 2000:
		PMIC_BUCK_ON_OFF(VDVFS11_INDEX);
		break;
	case 2001:
		PMIC_BUCK_ON_OFF(VDVFS12_INDEX);
		break;
	case 2002:
		PMIC_BUCK_ON_OFF(VDVFS13_INDEX);
		break;
	case 2003:
		PMIC_BUCK_ON_OFF(VDVFS14_INDEX);
		break;
	case 2004:
		PMIC_BUCK_ON_OFF(VGPU_INDEX);
		break;
	case 2005:
		PMIC_BUCK_ON_OFF(VCORE1_INDEX);
		break;
	case 2006:
		PMIC_BUCK_ON_OFF(VCORE2_INDEX);
		break;
	case 2007:
		PMIC_BUCK_ON_OFF(VIO18_INDEX);
		break;
	case 2008:
		PMIC_BUCK_ON_OFF(VDRAM_INDEX);
		break;
	case 2009:
		PMIC_BUCK_ON_OFF(VDVFS2_INDEX);
		break;
	case 2010:
		PMIC_BUCK_ON_OFF(VRF1_INDEX);
		break;
	case 2011:
		PMIC_BUCK_ON_OFF(VRF2_INDEX);
		break;
	case 2012:
		PMIC_BUCK_ON_OFF(VPA_INDEX);
		break;
	case 2013:
		PMIC_BUCK_ON_OFF(VSBST_INDEX);
		break;

	case 2014:
		PMIC_BUCK_VOSEL(VDVFS11_INDEX);
		break;
	case 2015:
		PMIC_BUCK_VOSEL(VDVFS12_INDEX);
		break;
	case 2016:
		PMIC_BUCK_VOSEL(VDVFS13_INDEX);
		break;
	case 2017:
		PMIC_BUCK_VOSEL(VDVFS14_INDEX);
		break;
	case 2018:
		PMIC_BUCK_VOSEL(VGPU_INDEX);
		break;
	case 2019:
		PMIC_BUCK_VOSEL(VCORE1_INDEX);
		break;
	case 2020:
		PMIC_BUCK_VOSEL(VCORE2_INDEX);
		break;
	case 2021:
		PMIC_BUCK_VOSEL(VIO18_INDEX);
		break;
	case 2022:
		PMIC_BUCK_VOSEL(VDRAM_INDEX);
		break;
	case 2023:
		PMIC_BUCK_VOSEL(VDVFS2_INDEX);
		break;
	case 2024:
		PMIC_BUCK_VOSEL(VRF1_INDEX);
		break;
	case 2025:
		PMIC_BUCK_VOSEL(VRF2_INDEX);
		break;
	case 2026:
		PMIC_BUCK_VOSEL(VPA_INDEX);
		break;
	case 2027:
		PMIC_BUCK_VOSEL(VSBST_INDEX);
		break;

	case 2028:
		PMIC_BUCK_DLC(VDVFS11_INDEX);
		break;
	case 2029:
		PMIC_BUCK_DLC(VDVFS12_INDEX);
		break;
	case 2030:
		PMIC_BUCK_DLC(VDVFS13_INDEX);
		break;
	case 2031:
		PMIC_BUCK_DLC(VDVFS14_INDEX);
		break;
	case 2032:
		PMIC_BUCK_DLC(VGPU_INDEX);
		break;
	case 2033:
		PMIC_BUCK_DLC(VCORE1_INDEX);
		break;
	case 2034:
		PMIC_BUCK_DLC(VCORE2_INDEX);
		break;
	case 2035:
		PMIC_BUCK_DLC(VIO18_INDEX);
		break;
	case 2036:
		PMIC_BUCK_DLC(VDRAM_INDEX);
		break;
	case 2037:
		PMIC_BUCK_DLC(VDVFS2_INDEX);
		break;
	case 2038:
		PMIC_BUCK_DLC(VRF1_INDEX);
		break;
	case 2039:
		PMIC_BUCK_DLC(VRF2_INDEX);
		break;
	case 2040:
		PMIC_BUCK_DLC(VPA_INDEX);
		break;
	case 2041:
		PMIC_BUCK_DLC(VSBST_INDEX);
		break;

	case 2042:
		PMIC_BUCK_BURST(VDVFS11_INDEX);
		break;
	case 2043:
		PMIC_BUCK_BURST(VDVFS12_INDEX);
		break;
	case 2044:
		PMIC_BUCK_BURST(VDVFS13_INDEX);
		break;
	case 2045:
		PMIC_BUCK_BURST(VDVFS14_INDEX);
		break;
	case 2046:
		PMIC_BUCK_BURST(VGPU_INDEX);
		break;
	case 2047:
		PMIC_BUCK_BURST(VCORE1_INDEX);
		break;
	case 2048:
		PMIC_BUCK_BURST(VCORE2_INDEX);
		break;
	case 2049:
		PMIC_BUCK_BURST(VIO18_INDEX);
		break;
	case 2050:
		PMIC_BUCK_BURST(VDRAM_INDEX);
		break;
	case 2051:
		PMIC_BUCK_BURST(VDVFS2_INDEX);
		break;
	case 2052:
		PMIC_BUCK_BURST(VRF1_INDEX);
		break;
	case 2053:
		PMIC_BUCK_BURST(VRF2_INDEX);
		break;
	case 2054:
		PMIC_BUCK_BURST(VPA_INDEX);
		break;
	case 2055:
		PMIC_BUCK_BURST(VSBST_INDEX);
		break;

		/* LDO */
	case 3000:
		exec_6331_ldo_vtcxo1_en_test();
		break;
	case 3001:
		exec_6331_ldo_vtcxo2_en_test();
		break;
	case 3002:
		exec_6331_ldo_vaud32_en_test();
		break;
	case 3003:
		exec_6331_ldo_vauxa32_en_test();
		break;
	case 3004:
		exec_6331_ldo_vcama_en_test();
		break;
	case 3005:
		exec_6331_ldo_vmch_en_test();
		break;
	case 3006:
		exec_6331_ldo_vemc33_en_test();
		break;
	case 3007:
		exec_6331_ldo_vio28_en_test();
		break;
	case 3008:
		exec_6331_ldo_vmc_en_test();
		break;
	case 3009:
		exec_6331_ldo_vcam_af_en_test();
		break;
	case 3010:
		exec_6331_ldo_vgp1_en_test();
		break;
	case 3011:
		exec_6331_ldo_vgp4_en_test();
		break;
	case 3012:
		exec_6331_ldo_vsim1_en_test();
		break;
	case 3013:
		exec_6331_ldo_vsim2_en_test();
		break;
	case 3014:
		exec_6331_ldo_vfbb_en_test();
		break;
	case 3015:
		exec_6331_ldo_vrtc_en_test();
		break;
	case 3016:
		exec_6331_ldo_vmipi_en_test();
		break;
	case 3017:
		exec_6331_ldo_vibr_en_test();
		break;
	case 3018:
		exec_6331_ldo_vdig18_en_test();
		break;
	case 3019:
		exec_6331_ldo_vcamd_en_test();
		break;
	case 3020:
		exec_6331_ldo_vusb10_en_test();
		break;
	case 3021:
		exec_6331_ldo_vcam_io_en_test();
		break;
	case 3022:
		exec_6331_ldo_vsram_dvfs1_en_test();
		break;
	case 3023:
		exec_6331_ldo_vgp2_en_test();
		break;
	case 3024:
		exec_6331_ldo_vgp3_en_test();
		break;
	case 3025:
		exec_6331_ldo_vbiasn_en_test();
		break;
	case 3026:
		exec_6332_ldo_vbif28_en_test();
		break;
	case 3027:
		exec_6332_ldo_vauxb32_en_test();
		break;
	case 3028:
		exec_6332_ldo_vusb33_en_test();
		break;
	case 3029:
		exec_6332_ldo_vdig18_en_test();
		break;
	case 3030:
		exec_6332_ldo_vsram_dvfs2_en_test();
		break;

	case 3031:
		exec_6331_ldo_vtcxo1_vosel_test();
		break;
	case 3032:
		exec_6331_ldo_vtcxo2_vosel_test();
		break;
	case 3033:
		exec_6331_ldo_vaud32_vosel_test();
		break;
	case 3034:
		exec_6331_ldo_vauxa32_vosel_test();
		break;
	case 3035:
		exec_6331_ldo_vcama_vosel_test();
		break;
	case 3036:
		exec_6331_ldo_vmch_vosel_test();
		break;
	case 3037:
		exec_6331_ldo_vemc33_vosel_test();
		break;
	case 3038:
		exec_6331_ldo_vio28_vosel_test();
		break;
	case 3039:
		exec_6331_ldo_vmc_vosel_test();
		break;
	case 3040:
		exec_6331_ldo_vcam_af_vosel_test();
		break;
	case 3041:
		exec_6331_ldo_vgp1_vosel_test();
		break;
	case 3042:
		exec_6331_ldo_vgp4_vosel_test();
		break;
	case 3043:
		exec_6331_ldo_vsim1_vosel_test();
		break;
	case 3044:
		exec_6331_ldo_vsim2_vosel_test();
		break;
	case 3045:
		exec_6331_ldo_vfbb_vosel_test();
		break;
	case 3046:
		exec_6331_ldo_vrtc_vosel_test();
		break;
	case 3047:
		exec_6331_ldo_vmipi_vosel_test();
		break;
	case 3048:
		exec_6331_ldo_vibr_vosel_test();
		break;
	case 3049:
		exec_6331_ldo_vdig18_vosel_test();
		break;
	case 3050:
		exec_6331_ldo_vcamd_vosel_test();
		break;
	case 3051:
		exec_6331_ldo_vusb10_vosel_test();
		break;
	case 3052:
		exec_6331_ldo_vcam_io_vosel_test();
		break;
	case 3053:
		exec_6331_ldo_vsram_dvfs1_vosel_test();
		break;
	case 3054:
		exec_6331_ldo_vgp2_vosel_test();
		break;
	case 3055:
		exec_6331_ldo_vgp3_vosel_test();
		break;
	case 3056:
		exec_6331_ldo_vbiasn_vosel_test();
		break;
	case 3057:
		exec_6332_ldo_vbif28_vosel_test();
		break;
	case 3058:
		exec_6332_ldo_vauxb32_vosel_test();
		break;
	case 3059:
		exec_6332_ldo_vusb33_vosel_test();
		break;
	case 3060:
		exec_6332_ldo_vdig18_vosel_test();
		break;
	case 3061:
		exec_6332_ldo_vsram_dvfs2_vosel_test();
		break;

		/* 31 vsram_dvfs1, vfbb, vrtc, vdig18 : no cal */
		/* 32 vsram_dfvs2, dig18 : no cal */
	case 3062:
		exec_6331_ldo_vtcxo1_cal_test();
		break;
	case 3063:
		exec_6331_ldo_vtcxo2_cal_test();
		break;
	case 3064:
		exec_6331_ldo_vaud32_cal_test();
		break;
	case 3065:
		exec_6331_ldo_vauxa32_cal_test();
		break;
	case 3066:
		exec_6331_ldo_vcama_cal_test();
		break;
	case 3067:
		exec_6331_ldo_vmch_cal_test();
		break;
	case 3068:
		exec_6331_ldo_vemc33_cal_test();
		break;
	case 3069:
		exec_6331_ldo_vio28_cal_test();
		break;
	case 3070:
		exec_6331_ldo_vmc_cal_test();
		break;
	case 3071:
		exec_6331_ldo_vcam_af_cal_test();
		break;
	case 3072:
		exec_6331_ldo_vgp1_cal_test();
		break;
	case 3073:
		exec_6331_ldo_vgp4_cal_test();
		break;
	case 3074:
		exec_6331_ldo_vsim1_cal_test();
		break;
	case 3075:
		exec_6331_ldo_vsim2_cal_test();
		break;
	case 3076:
		exec_6331_ldo_vfbb_cal_test();
		break;
	case 3077:
		exec_6331_ldo_vrtc_cal_test();
		break;
	case 3078:
		exec_6331_ldo_vmipi_cal_test();
		break;
	case 3079:
		exec_6331_ldo_vibr_cal_test();
		break;
	case 3080:
		exec_6331_ldo_vdig18_cal_test();
		break;
	case 3081:
		exec_6331_ldo_vcamd_cal_test();
		break;
	case 3082:
		exec_6331_ldo_vusb10_cal_test();
		break;
	case 3083:
		exec_6331_ldo_vcam_io_cal_test();
		break;
	case 3084:
		exec_6331_ldo_vsram_dvfs1_cal_test();
		break;
	case 3085:
		exec_6331_ldo_vgp2_cal_test();
		break;
	case 3086:
		exec_6331_ldo_vgp3_cal_test();
		break;
	case 3087:
		exec_6331_ldo_vbiasn_cal_test();
		break;
	case 3088:
		exec_6332_ldo_vbif28_cal_test();
		break;
	case 3089:
		exec_6332_ldo_vauxb32_cal_test();
		break;
	case 3090:
		exec_6332_ldo_vusb33_cal_test();
		break;
	case 3091:
		exec_6332_ldo_vdig18_cal_test();
		break;
	case 3092:
		exec_6332_ldo_vsram_dvfs2_cal_test();
		break;

	case 3093:
		exec_6331_ldo_vtcxo1_mode_test();
		break;
	case 3094:
		exec_6331_ldo_vtcxo2_mode_test();
		break;
	case 3095:
		exec_6331_ldo_vaud32_mode_test();
		break;
	case 3096:
		exec_6331_ldo_vauxa32_mode_test();
		break;
	case 3097:
		exec_6331_ldo_vcama_mode_test();
		break;
	case 3098:
		exec_6331_ldo_vmch_mode_test();
		break;
	case 3099:
		exec_6331_ldo_vemc33_mode_test();
		break;
	case 3100:
		exec_6331_ldo_vio28_mode_test();
		break;
	case 3101:
		exec_6331_ldo_vmc_mode_test();
		break;
	case 3102:
		exec_6331_ldo_vcam_af_mode_test();
		break;
	case 3103:
		exec_6331_ldo_vgp1_mode_test();
		break;
	case 3104:
		exec_6331_ldo_vgp4_mode_test();
		break;
	case 3105:
		exec_6331_ldo_vsim1_mode_test();
		break;
	case 3106:
		exec_6331_ldo_vsim2_mode_test();
		break;
	case 3107:
		exec_6331_ldo_vfbb_mode_test();
		break;
	case 3108:
		exec_6331_ldo_vrtc_mode_test();
		break;
	case 3109:
		exec_6331_ldo_vmipi_mode_test();
		break;
	case 3110:
		exec_6331_ldo_vibr_mode_test();
		break;
	case 3111:
		exec_6331_ldo_vdig18_mode_test();
		break;
	case 3112:
		exec_6331_ldo_vcamd_mode_test();
		break;
	case 3113:
		exec_6331_ldo_vusb10_mode_test();
		break;
	case 3114:
		exec_6331_ldo_vcam_io_mode_test();
		break;
	case 3115:
		exec_6331_ldo_vsram_dvfs1_mode_test();
		break;
	case 3116:
		exec_6331_ldo_vgp2_mode_test();
		break;
	case 3117:
		exec_6331_ldo_vgp3_mode_test();
		break;
	case 3118:
		exec_6331_ldo_vbiasn_mode_test();
		break;
	case 3119:
		exec_6332_ldo_vbif28_mode_test();
		break;
	case 3120:
		exec_6332_ldo_vauxb32_mode_test();
		break;
	case 3121:
		exec_6332_ldo_vusb33_mode_test();
		break;
	case 3122:
		exec_6332_ldo_vdig18_mode_test();
		break;
	case 3123:
		exec_6332_ldo_vsram_dvfs2_mode_test();
		break;

		/* EFUSE */
	case 4001:
		exec_6331_efuse_test();
		break;
	case 4002:
		exec_6332_efuse_test();
		break;
	...
	case 6003:
		...
		break;
	case 6004:
		auxadc_priority_test_GPSMD1_6331();
		break;
	case 6005:
		auxadc_priority_test_GPSMD2_6331();
		break;
	case 6006:
		auxadc_priority_test_GPSMD3_6331();
		break;

	case 6007:
		auxadc_low_battery_int_test_6331();
		break;
	case 6008:
		auxadc_high_battery_int_test_6331();
		break;
	case 6009:
		auxadc_low_battery_int2_test_6331();
		break;
	case 6010:
		auxadc_high_battery_int2_test_6331();
		break;
	case 6011:
		auxadc_low_battery_int_test_6332();
		break;
	case 6012:
		auxadc_high_battery_int_test_6332();
		break;
	case 6013:
		auxadc_low_battery_int2_test_6332();
		break;
	case 6014:
		auxadc_high_battery_int2_test_6332();
		break;

	case 6015:
		auxadc_low_thermal_int_test_6331();
		break;
	case 6016:
		auxadc_high_thermal_int_test_6331();
		break;
	case 6017:
		auxadc_low_thermal_int2_test_6331();
		break;
	case 6018:
		auxadc_high_thermal_int2_test_6331();
		break;
	case 6019:
		auxadc_low_thermal_int_test_6332();
		break;
	case 6020:
		auxadc_high_thermal_int_test_6332();
		break;
	case 6021:
		auxadc_low_thermal_int2_test_6332();
		break;
	case 6022:
		auxadc_high_thermal_int2_test_6332();
		break;

	case 6023:
		auxadc_measure_poweron_test_6331();
		break;
	case 6024:
		auxadc_measure_wakeup_test_6331();
		break;
	case 6025:
		auxadc_measure_poweron_test_6332();
		break;
	case 6026:
		auxadc_measure_wakeup_test_6332();
		break;

	case 6027:
		auxadc_swctrl_measure_test_6331();
		break;
	case 6028:
		auxadc_swctrl_measure_test_6332();
		break;

	case 6029:
		auxadc_accdet_auto_sampling_test();
		break;

	case 6030:
		auxadc_request_one_channel(0);
		break;
	case 6031:
		auxadc_request_one_channel(1);
		break;
	case 6032:
		auxadc_request_one_channel(2);
		break;
	case 6033:
		auxadc_request_one_channel(3);
		break;
	case 6034:
		auxadc_request_one_channel(4);
		break;
	case 6035:
		auxadc_request_one_channel(5);
		break;
	case 6036:
		auxadc_request_one_channel(6);
		break;
	case 6037:
		auxadc_request_one_channel(7);
		break;
	case 6038:
		auxadc_request_one_channel(8);
		break;
	case 6039:
		auxadc_request_one_channel(9);
		break;
	case 6040:
		auxadc_request_one_channel(10);
		break;
	case 6041:
		auxadc_request_one_channel(11);
		break;
	case 6042:
		auxadc_request_one_channel(12);
		break;
	case 6043:
		auxadc_request_one_channel(13);
		break;
	case 6044:
		auxadc_request_one_channel(14);
		break;
	case 6045:
		auxadc_request_one_channel(15);
		break;
	case 6046:
		auxadc_request_one_channel(16);
		break;
	case 6047:
		auxadc_request_one_channel(17);
		break;
	case 6048:
		auxadc_request_one_channel(18);
		break;
	case 6049:
		auxadc_request_one_channel(19);
		break;
	case 6050:
		auxadc_request_one_channel(20);
		break;
	case 6051:
		auxadc_request_one_channel(21);
		break;
	default:
