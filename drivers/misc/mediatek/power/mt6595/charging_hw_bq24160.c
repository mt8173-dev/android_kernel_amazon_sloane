...
const kal_uint32 CS_VTH[] = {
	CHARGE_CURRENT_550_00_MA, CHARGE_CURRENT_625_00_MA, CHARGE_CURRENT_700_00_MA,
	CHARGE_CURRENT_775_00_MA,
	CHARGE_CURRENT_850_00_MA, CHARGE_CURRENT_925_00_MA, CHARGE_CURRENT_1000_00_MA,
	CHARGE_CURRENT_1075_00_MA,
	CHARGE_CURRENT_1150_00_MA, CHARGE_CURRENT_1225_00_MA, CHARGE_CURRENT_1300_00_MA,
	CHARGE_CURRENT_1375_00_MA,
	CHARGE_CURRENT_1450_00_MA, CHARGE_CURRENT_1525_00_MA, CHARGE_CURRENT_1600_00_MA,
	CHARGE_CURRENT_1675_00_MA,
	CHARGE_CURRENT_1750_00_MA, CHARGE_CURRENT_1825_00_MA, CHARGE_CURRENT_1900_00_MA,
	CHARGE_CURRENT_1975_00_MA,
	CHARGE_CURRENT_2050_00_MA, CHARGE_CURRENT_2125_00_MA, CHARGE_CURRENT_2200_00_MA,
	CHARGE_CURRENT_2275_00_MA,
	CHARGE_CURRENT_2350_00_MA, CHARGE_CURRENT_2425_00_MA, CHARGE_CURRENT_2500_00_MA,
	CHARGE_CURRENT_2575_00_MA,
	CHARGE_CURRENT_2650_00_MA, CHARGE_CURRENT_2725_00_MA, CHARGE_CURRENT_2800_00_MA,
	CHARGE_CURRENT_2875_00_MA
};
...
static kal_uint32 charging_hw_init(void *data)
{
	...
	battery_xlog_printk(BAT_LOG_CRTI, "[charging_hw_init] From Tim\n");
	...
	bq24160_config_interface(bq24160_CON3, 0x2A, 0x3F, 2);	/* CV=4.34V */
#else
	...
	*(CHARGER_TYPE *) (data) = STANDARD_HOST;
	...
	if (get_pmic_mt6332_cid() == PMIC6332_E1_CID_CODE) {
		...
		while (dpdm_bit != 0) {
			...
			battery_xlog_printk(BAT_LOG_CRTI,
					    "[charging_get_charger_type] bq24160_CON3[0]=%d\n",
					    dpdm_bit);
		...
		if (i > i_timeout) {
			*(CHARGER_TYPE *) (data) = STANDARD_HOST;
			battery_xlog_printk(BAT_LOG_CRTI,
					    "[charging_get_charger_type] timeout(%d) : step=STANDARD_HOST\n",
					    i);
		} else {
			...
			if (val == 0) {
				*(CHARGER_TYPE *) (data) = STANDARD_HOST;
				battery_xlog_printk(BAT_LOG_CRTI,
						    "[charging_get_charger_type] E1 workaround (%d), step=STANDARD_HOST\n",
						    val);
			} else {
				*(CHARGER_TYPE *) (data) = STANDARD_CHARGER;
				battery_xlog_printk(BAT_LOG_CRTI,
						    "[charging_get_charger_type] E1 workaround (%d), step=STANDARD_CHARGER\n",
						    val);
			}
		}
		/* ----------------------------------------------------- */
...
static kal_uint32 charging_enable_powerpath(void *data)
{
	...
	if (KAL_TRUE == enable)
		bq24160_set_hz_mode(0x0);
	else
		bq24160_set_hz_mode(0x1);
...
charging_hw_init, charging_dump_register, charging_enable, charging_set_cv_voltage,
	    ...
	    charging_get_platfrom_boot_mode, charging_enable_powerpath, charging_set_power_off};
