...
static U32 hw_bc12_DCD(void)
{
	...
	if (get_pmic_mt6332_cid() == PMIC6332_E1_CID_CODE)
		mt6332_upmu_set_rg_bc12_ipu_en(0x1);
	else
		mt6332_upmu_set_rg_bc12_ipu_en(0x2);

	/* RG_bc12_IPD_EN[1.0] = 01 */
	if (get_pmic_mt6332_cid() == PMIC6332_E1_CID_CODE)
		mt6332_upmu_set_rg_bc12_ipd_en(0x2);
	else
		mt6332_upmu_set_rg_bc12_ipd_en(0x1);
	...
	if (get_pmic_mt6332_cid() == PMIC6332_E1_CID_CODE)
		mt6332_upmu_set_rg_bc12_cmp_en(0x1);
	else
		mt6332_upmu_set_rg_bc12_cmp_en(0x2);
...
static U32 hw_bc12_stepA2(void)
{
	...
	if (get_pmic_mt6332_cid() == PMIC6332_E1_CID_CODE)
		mt6332_upmu_set_rg_bc12_vsrc_en(0x1);
	else
		mt6332_upmu_set_rg_bc12_vsrc_en(0x2);
