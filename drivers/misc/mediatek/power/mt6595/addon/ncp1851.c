...
/**********************************************************
  ...
  *
  *********************************************************/
kal_uint32 ncp1851_read_interface(kal_uint8 RegNum, kal_uint8 *val, kal_uint8 MASK,
				  kal_uint8 SHIFT)
{
...
kal_uint32 ncp1851_config_interface(kal_uint8 RegNum, kal_uint8 val, kal_uint8 MASK,
				    kal_uint8 SHIFT)
{
	kal_uint8 ncp1851_reg = 0;
	int ret = 0;
...
kal_uint32 ncp1851_get_ntc(void)
{
	...
	ret = ncp1851_read_interface((kal_uint8) (NCP1851_CON0),
				     (kal_uint8 *) (&val),
				     (kal_uint8) (CON0_NTC_MASK), (kal_uint8) (CON0_NTC_SHIFT)
	    );
	return val;
}
...
static ssize_t store_ncp1851_access(struct device *dev, struct device_attribute *attr,
