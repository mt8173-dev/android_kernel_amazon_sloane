...
int upmu_set_rg_wrp_i2c_pdn(u32 val, u32 n_i2c)
{
	int err;
	if (n_i2c >= 3)
		return -ENODEV;
...
void upmu_set_rg_vgp1_sw_en(U32 val)
{
	U32 ret = 0;
...
void upmu_set_rg_vgp1_ocfb_en(U32 val)
{
	U32 ret = 0;
...
void upmu_set_rg_vgp2_sw_en(U32 val)
{
	U32 ret = 0;
...
void upmu_set_rg_vgp2_ocfb_en(U32 val)
{
	U32 ret = 0;
...
void upmu_set_rg_vgp3_sw_en(U32 val)
{
	U32 ret = 0;
...
void upmu_set_rg_vgp3_ocfb_en(U32 val)
{
	U32 ret = 0;
