...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = { {5343, 3007, 8, 8, 5343, 3007, 2668, 1500, 0000, 0000, 2668, 1500, 0, 0, 2668, 1500},	/* Preview */
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_IHDR_SHUTTER_GAIN:
		...
		break;
	default:
		LOG_WRN("WARNING: Unsupported cmd id: %d\n", feature_id);
		break;
	}
