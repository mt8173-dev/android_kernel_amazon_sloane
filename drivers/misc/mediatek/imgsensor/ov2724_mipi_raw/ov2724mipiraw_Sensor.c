...
static int main_sensor_init_setting_switch = 0;
...
static imgsensor_info_struct imgsensor_info = { 
	...
	.slim_video = { //equal preview setting
		.pclk = 160000000,
		.linelength = 2282,  /*[actually 1923*2]	*/			//record different mode's linelength
		.framelength = 2336,								//record different mode's framelength
		.startx = 0,										//record different mode's startx of grabwindow
		.starty = 0,										//record different mode's starty of grabwindow
...
{{ 1920, 1080, 0, 0, 1920, 1080,    1920,1080,0,0,  1920,1080,	  0,0,1920,1080}, // Preview 
 ...
 { 1920, 1080, 0, 0, 1920, 1080,    1920,1080,0,0,  1920,1080,	  0,0,1920,1080}};// Custom5
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0x3019, 0xf0);	/* d2 *//* sensor temperature default: ON */
