...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{1280, 720, 0, 0, 1280, 720, 1280, 720, 0000, 0000, 1280, 720, 0, 0, 1280, 720}
};				/* slim video */


static void do_nothing(void)
{
	/* just do nothing, for fixing some warnings */
}
...
static void set_dummy(void)
{
	...
	if (sub_sensor_init_setting_switch != 0)	/* FATP bypass */
		return;
...
static kal_uint16 set_gain(kal_uint16 gain)
{
	...
	switch (sub_sensor_init_setting_switch) {
	case 1:/* LSC OFF */
	case 3:
	case 4:/* KK LSC ON */
		reg_gain = 0x00;	/* means 1x */
		break;
	case 2:
		reg_gain = 0x70;	/* means 8x */
		break;
	default:
		{
	...
	LOG_INF("FATP mode (%d) gain = %d , reg_gain = 0x%x\n ",
			sub_sensor_init_setting_switch, gain, reg_gain);
...
static void sensor_init(void)
{
    ...
    */
	...
	write_cmos_sensor(0x0203, 0xf9);	/* exposure low bit */
	...
	write_cmos_sensor(0x0101, 0x02);	/* mirror & flip */
	write_cmos_sensor(0x5110, 0x01);	/*  */
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_FACTORY_MODE:
		*feature_return_para_32 = sub_sensor_init_setting_switch;
		*feature_para_len = 4;
		break;
	default:
		break;
