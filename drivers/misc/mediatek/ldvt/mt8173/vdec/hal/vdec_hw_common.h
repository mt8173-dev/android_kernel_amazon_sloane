...
#define RW_VLD_TOP_COPY_MEM_DRAM_BASE                       0xBC
#define RW_VLD_TOP_COPY_MEM_SRAM_SETTING                    0xC0
#define RW_VLD_TOP_COPY_MEM_SRAM_SETTING_VAL_DEFAULT        0x2200400
#define RO_VLD_TOP_COPY_MEM_STATUS                          0xC4
#define RO_VLD_TOP_COPY_MEM_STATUS_FLD_COPY_TRIG            0x0
#define RO_VLD_TOP_COPY_MEM_STATUS_FLD_COPY_MODE            0x1
#define RO_VLD_TOP_COPY_MEM_STATUS_VAL_DRAM_TO_SRAM         0x0
#define RO_VLD_TOP_COPY_MEM_STATUS_VAL_SRAM_TO_DRAM         0x1
#define RO_VLD_TOP_COPY_MEM_STATUS_FLD_COPY_BUSY            0x2
#endif
...
#define HEVC_MC_UFO_ONOFF		0xA60
