...
void vRCVFileHeader(UINT32 u4InstID)
{
  ...
  _tVerMpvDecPrm[u4InstID].u4PicW = _tVerPic[u4InstID].u4W;
        ...
        u4PIC_WIDTH[u4InstID] = ((_tVerMpvDecPrm[u4InstID].u4PicW + 63) >> 6) << 6;
        u4PIC_HEIGHT[u4InstID] = ((_tVerMpvDecPrm[u4InstID].u4PicH + 63) >> 6) << 6;
        ...
        printk("vRCVFileHeader _pucPic0C[u4InstID]        0x%x\n",_pucPic0C[u4InstID]);
        printk("vRCVFileHeader _pucPic1C[u4InstID]        0x%x\n",_pucPic1C[u4InstID]);
        printk("vRCVFileHeader _pucPic2C[u4InstID]        0x%x\n",_pucPic2C[u4InstID]);
        ...
        printk("vRCVFileHeader _tVerMpvDecPrm[u4InstID].u4PIC_SIZE_BS       0x%x\n",_tVerMpvDecPrm[u4InstID].u4PIC_SIZE_BS);
        printk("vRCVFileHeader _tVerMpvDecPrm[u4InstID].u4UFO_LEN_SIZE_Y    0x%x\n",_tVerMpvDecPrm[u4InstID].u4UFO_LEN_SIZE_Y);
        printk("vRCVFileHeader_tVerMpvDecPrm[u4InstID].u4PIC_SIZE_Y_BS      0x%x\n",_tVerMpvDecPrm[u4InstID].u4PIC_SIZE_Y_BS);
        printk("vRCVFileHeader u4DramPicSize                                0x%x\n",u4DramPicSize);
        printk("vRCVFileHeader _u4DramPicArea                               0x%x\n",u4DramPicArea);
...
void vWMVSearchSliceStartCode(UINT32 u4InstID)
{
   ...
   UCHAR  ucIdx;
   printk("---vWMVSearchSliceStartCode  enter---0x%x\n", u4PicStartAddr);
   u4SliceHdrCnt = 0;
   ...
   printk("---vWMVSearchSliceStartCode	leave---\n");
...
UINT32 decodeSequenceHead_Advanced(UINT32 u4InstID)
{
  ...
  _tVerMpvDecPrm[u4InstID].u4PicW = _tVerPic[u4InstID].u4W;
   _tVerMpvDecPrm[u4InstID].u4PicBW = _tVerPic[u4InstID].u4W;
        ...
        printk("SequenceHead_Advanced  _pucPic0C[u4InstID]        0x%x\n",_pucPic0C[u4InstID]);
        printk("SequenceHead_Advanced  _pucPic1C[u4InstID]        0x%x\n",_pucPic1C[u4InstID]);
        printk("SequenceHead_Advanced  _pucPic2C[u4InstID]        0x%x\n",_pucPic2C[u4InstID]);
        ...
        printk("SequenceHead_Advanced _tVerMpvDecPrm[u4InstID].u4PIC_SIZE_BS       0x%x\n",_tVerMpvDecPrm[u4InstID].u4PIC_SIZE_BS);
        printk("SequenceHead_Advanced _tVerMpvDecPrm[u4InstID].u4UFO_LEN_SIZE_Y    0x%x\n",_tVerMpvDecPrm[u4InstID].u4UFO_LEN_SIZE_Y);
        printk("SequenceHead_Advanced _tVerMpvDecPrm[u4InstID].u4PIC_SIZE_Y_BS     0x%x\n",_tVerMpvDecPrm[u4InstID].u4PIC_SIZE_Y_BS);
        printk("SequenceHead_Advanced u4DramPicSize                                0x%x\n",u4DramPicSize);
        printk("SequenceHead_Advanced _u4DramPicArea                               0x%x\n",u4DramPicArea);
#endif
...
UINT32 DecodeEntryPointHeader(UINT32 u4InstID)
{
  ...
  if(fgCoded_Size_Flag)
  {
    ...
    printk("DecodeEntryPointerHeader prWMVEPS->u4CodedWidth %d\n",prWMVEPS->u4CodedWidth);
    printk("DecodeEntryPointerHeader prWMVEPS->u4CodedHeight %d\n",prWMVEPS->u4CodedHeight);
    // Robert: translate to what I use
    ...
    _tVerMpvDecPrm[u4InstID].u4PicBW = _tVerPic[u4InstID].u4W;
        ...
        printk("EntryPointHeader  _pucPic0C[u4InstID]        0x%x\n",_pucPic0C[u4InstID]);
        printk("EntryPointHeader  _pucPic1C[u4InstID]        0x%x\n",_pucPic1C[u4InstID]);
        printk("EntryPointHeader  _pucPic2C[u4InstID]        0x%x\n",_pucPic2C[u4InstID]);
        ...
        printk("EntryPointHeader _tVerMpvDecPrm[u4InstID].u4PIC_SIZE_BS       0x%x\n",_tVerMpvDecPrm[u4InstID].u4PIC_SIZE_BS);
        printk("EntryPointHeader _tVerMpvDecPrm[u4InstID].u4UFO_LEN_SIZE_Y    0x%x\n",_tVerMpvDecPrm[u4InstID].u4UFO_LEN_SIZE_Y);
        printk("EntryPointHeader _tVerMpvDecPrm[u4InstID].u4PIC_SIZE_Y_BS     0x%x\n",_tVerMpvDecPrm[u4InstID].u4PIC_SIZE_Y_BS);
        printk("EntryPointHeader u4DramPicSize                                0x%x\n",u4DramPicSize);
        printk("EntryPointHeader u4DramPicArea                                0x%x\n",u4DramPicArea);
#endif
    SetupMultiResParams(u4InstID);
  }
  if(prWMVEPS->fgExtendedMvMode)
