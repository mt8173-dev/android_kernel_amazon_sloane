...
#define VDEC_VP8_IMAGERESIZE_SUPPORT 0

#if VDEC_VP8_IMAGERESIZE_SUPPORT
#define WEBP_RESZ_TMP_SIZE 16384*8
#define WEBP_RESZ_Y_SIZE  0x1A00000
#define WEBP_RESZ_C_SIZE  0xD00000
#endif
#if VDEC_VP8_WRAPPER_OFF
#if VDEC_VP8_WEBP_SUPPORT_ME2_INTEGRATION
#if VDEC_VP8_IMAGERESIZE_SUPPORT

#define GOLD_Y_SZ  WEBP_RESZ_Y_SIZE
#define GOLD_C_SZ  WEBP_RESZ_C_SIZE
...
#define GOLD_Y_SZ  0x420000  //256*16888
#define GOLD_C_SZ  0x210000  
#else
#define GOLD_Y_SZ  0xB00000 //0x400000  //4096 x 2176 * 1.25 (for 10 bit compact mode)
#define GOLD_C_SZ  0x580000 //0x1FE000  //GOLD_Y_SZ >> 1
#endif
#endif
...
#define MERGE_CRC_BUF_SZ  0x400000
#if 1
#if VDEC_VP8_WRAPPER_OFF
#define V_FIFO_SZ 0x01900000 //0x0800000
#else
#define V_FIFO_SZ 0x2000000 //0x01900000//0x05000000 //0x1000000
#endif
...
#define DPB_SZ    0x6000000 //0x2000000 //0x01C00000 //(12288*1024)
...
#define PRED_SZ 50664 
#define IP_SZ   50664
#define VBUF_SZ 33776
#define SAO_SZ  69632//4352x16
#define DBK_SZ  294912//18432x16
