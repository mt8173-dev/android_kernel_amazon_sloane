...
extern UCHAR *_pucVLDPredBuf[2];
extern UCHAR *_pucVLDIPBuf[2];
extern UCHAR *_pucVLDVBuf[2];
extern UCHAR *_pucPPSAOBuf[2];
extern UCHAR *_pucPPDBKBuf[2];
...
extern UCHAR *_pucPicTolCnt[2];
extern UCHAR *_pucMergeCRCBuf[2];
...
#if HEVC_CRC_COMPARE
extern UCHAR *_pucH265CRCYBuf0[2]; // multi-core 0
extern UCHAR *_pucH265CRCCBuf0[2]; // multi-core 0
extern UCHAR *_pucH265CRCYBuf1[2]; // multi-core 1
extern UCHAR *_pucH265CRCCBuf1[2]; // multi-core 1
#endif
...
extern UINT32 _u4ESAValue[2][14];
...
//UFO
extern UINT32  u4PIC_WIDTH[2];
extern UINT32  u4PIC_HEIGHT[2];
extern UINT32  u4PIC_SIZE_Y[2];
extern UINT32  u4PIC_SIZE[2];
extern UINT32  u4UFO_LEN_SIZE_Y[2];
extern UINT32  u4UFO_LEN_SIZE_C[2];
extern UINT32  u4PIC_SIZE_Y_BS[2];
extern UINT32  u4PIC_SIZE_BS[2];
extern UINT32  u4PIC_SIZE_REF[2];
...
extern VDEC_INFO_VERIFY_FILE_INFO_T _tInCRCFileInfo[2];
...
extern UINT32 _u4Main10Mode;
#if 1 //MT8137 HEVC VP Mode
extern UINT32 _u4VPMode;
#endif
...
extern UCHAR *_pucWebpReszWorkBuf[2];
extern UCHAR *_pucWebpReszFrameYAddr[2];
extern UCHAR *_pucWebpReszFrameCAddr[2];

extern BOOL   _fgFirstMBRow;
...
extern UINT32 _u4PicTotalCnt[2];
