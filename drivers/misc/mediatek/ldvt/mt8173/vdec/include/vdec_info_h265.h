...
#define HEVC_16BIT_MODE   1
#define HEVC_REORDER_MODE 2
#define HEVC_COMPACT_MODE 3

#if 1 //MT8137 HEVC VP Mode
#define HEVC_BLOCK_MODE 0
#define HEVC_ADDRESS_MODE 1
#endif
...
typedef struct _VDEC_INFO_H265_LAST_INFO_T_
{
    ...
    UINT32 u4LastPicWidthInLumaSamples;
    UINT32 u4LastPicHeightInLumaSamples;
#endif
