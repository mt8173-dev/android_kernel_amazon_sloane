...
static void simp_msdc_dump_register(struct simp_msdc_host *host)
{
	...
	printk(KERN_EMERG
	       "R[00]=0x%x  R[04]=0x%x  R[08]=0x%x  R[0C]=0x%x  R[10]=0x%x  R[14]=0x%x\n",
	...
	printk(KERN_EMERG
	       "R[30]=0x%x  R[34]=0x%x  R[38]=0x%x  R[3C]=0x%x  R[40]=0x%x  R[44]=0x%x\n",
	...
	printk(KERN_EMERG
	       "R[48]=0x%x  R[4C]=0x%x  R[50]=0x%x  R[58]=0x%x  R[5C]=0x%x  R[60]=0x%x\n",
	...
	printk(KERN_EMERG
	       "R[70]=0x%x  R[74]=0x%x  R[78]=0x%x  R[7C]=0x%x  R[80]=0x%x  R[84]=0x%x\n",
	...
	printk(KERN_EMERG
	       "R[88]=0x%x  R[90]=0x%x  R[94]=0x%x  R[98]=0x%x  R[9C]=0x%x  R[A0]=0x%x\n",
	...
	printk(KERN_EMERG
	       "R[A4]=0x%x  R[A8]=0x%x  R[B0]=0x%x  R[B4]=0x%x  R[E0]=0x%x  R[E4]=0x%x\n",
	...
	printk(KERN_EMERG
	       "R[E8]=0x%x  R[EC]=0x%x  R[F0]=0x%x  R[F4]=0x%x  R[F8]=0x%x  R[100]=0x%x  R[104]=0x%x\n",
	...
	if (host->id == 0) {
		printk(KERN_EMERG
		       "R[%x]=0x%x  R[%x]=0x%x  R[%x]=0x%x  R[%x]=0x%x  R[%x]=0x%x  R[%x]=0x%x\n",
		...
		printk(KERN_EMERG "R[%x]=0x%x  R[%x]=0x%x\n", MSDC0_GPIO_MODE2_BASE,
		       sdr_read32(MSDC0_GPIO_MODE2_BASE), MSDC0_GPIO_MODE3_BASE,
...
#if MTK_MMC_DUMP_DBG
	printk(KERN_EMERG
	       "[pll]0xF020925C =0x%x, 0xF0209250 =0x%x, [mux]0xF0000070 =0x%x, [clk]0xF0003018 =0x%x\n",
	       sdr_read32(0xF020925C), sdr_read32(0xF0209250), sdr_read32(0xF0000070),
