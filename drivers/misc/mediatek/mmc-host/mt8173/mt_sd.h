...
#if defined(CONFIG_REGULATOR) && !defined(CONFIG_FPGA_EARLY_PORTING)
#define MTK_MSDC_USE_REGULATOR
#endif

#ifdef MTK_MSDC_USE_REGULATOR
#include <linux/regulator/consumer.h>
#define MSDC_REGULATOR_CNT_MAX	(2)
#endif
...
#define MSDC_GPIO_BASE	msdc_gpio_base
...
#define MSDC0_GPIO_MODE0_BASE                 (MSDC_GPIO_BASE + 0x6B0)
#define MSDC0_GPIO_MODE1_BASE                 (MSDC_GPIO_BASE + 0x6C0)
#define MSDC0_GPIO_MODE2_BASE                 (MSDC_GPIO_BASE + 0x6D0)
...
#define MSDC1_GPIO_MODE0_BASE                 (MSDC_GPIO_BASE + 0x6E0)
#define MSDC1_GPIO_MODE1_BASE                 (MSDC_GPIO_BASE + 0x6F0)
...
#define MSDC2_GPIO_DAT1_BASE                  (MSDC_GPIO_BASE + 0xD40)
...
#define MSDC3_GPIO_DAT1_BASE                  (MSDC_GPIO_BASE + 0xD60)
#define MSDC3_GPIO_DS_BASE                    (MSDC_GPIO_BASE + 0xD70)
...
struct msdc_host {
	...
	int sd_cd_irq;		/* sd card detection irq */
...
#endif
	void __iomem *gpio_base[GPIO_CTRL_MAX];	/* pad ctrl register base */
#ifdef MTK_MSDC_USE_REGULATOR
	struct regulator *regulator[MSDC_REGULATOR_CNT_MAX];
#endif
	struct clk *clk;
