...
__weak void get_kernel_log_buffer(unsigned long *addr, unsigned long *size, unsigned long *start)
{
	return;
}

__weak void get_android_log_buffer(unsigned long *addr, unsigned long *size, unsigned long *start, int type)
{
	return;
}
