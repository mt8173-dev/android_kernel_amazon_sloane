...
static const u3p_c60802_regs g_c60802_regs = {
#ifdef CONFIG_U3_PHY_GPIO_SUPPORT
	.u2phy_regs_c = (struct u2phy_reg_c *)0x0;
	.u3phyd_regs_c = (struct u3phyd_reg_c *)0x100000;
	.u3phyd_bank2_regs_c = (struct u3phyd_bank2_reg_c *)0x200000;
	.u3phya_regs_c = (struct u3phya_reg_c *)0x300000;
	.u3phya_da_regs_c = (struct u3phya_da_reg_c *)0x400000;
	.sifslv_chip_regs_c = (struct sifslv_chip_reg_c *)0x500000;
	.sifslv_fm_regs_c = (struct sifslv_fm_feg_c *)0xf00000;
#else
	.u2phy_regs_c = (struct u2phy_reg_c *)U2_PHY_BASE;
	.u3phyd_regs_c = (struct u3phyd_reg_c *)U3_PHYD_BASE;
	.u3phyd_bank2_regs_c = (struct u3phyd_bank2_reg_c *)U3_PHYD_B2_BASE;
	.u3phya_regs_c = (struct u3phya_reg_c *)U3_PHYA_BASE;
	.u3phya_da_regs_c = (struct u3phya_da_reg_c *)U3_PHYA_DA_BASE;
	.sifslv_chip_regs_c = (struct sifslv_chip_reg_c *)SIFSLV_CHIP_BASE;
	.sifslv_fm_regs_c = (struct sifslv_fm_feg_c *)SIFSLV_FM_FEG_BASE;
#endif
};

PHY_INT32 phy_init_c60802(struct u3phy_info *uinfo)
{
	struct u3p_c60802_regs *info = (struct u3p_c60802_regs *)uinfo->reg_info;
	PHY_UINT8 temp;
...
PHY_INT32 phy_change_pipe_phase_c60802(struct u3phy_info *uinfo, PHY_INT32 phy_drv,
...
PHY_INT32 eyescan_init_c60802(struct u3phy_info *uinfo)
{
	struct u3p_c60802_regs *info = (struct u3p_c60802_regs *)uinfo->reg_info;
...
PHY_INT32 phy_eyescan_c60802(struct u3phy_info *uinfo, PHY_INT32 x_t1, PHY_INT32 y_t1,
...
PHY_INT32 u2_connect_c60802(struct u3phy_info *uinfo)
{
	struct u3p_c60802_regs *info = (struct u3p_c60802_regs *)uinfo->reg_info;
...
PHY_INT32 u2_disconnect_c60802(struct u3phy_info *uinfo)
{
	struct u3p_c60802_regs *info = (struct u3p_c60802_regs *)uinfo->reg_info;
...
PHY_INT32 u2_save_cur_en_c60802(struct u3phy_info *uinfo)
{
	struct u3p_c60802_regs *info = (struct u3p_c60802_regs *)uinfo->reg_info;
...
PHY_INT32 u2_save_cur_re_c60802(struct u3phy_info *uinfo)
{
	struct u3p_c60802_regs *info = (struct u3p_c60802_regs *)uinfo->reg_info;
...
PHY_INT32 u2_slew_rate_calibration_c60802(struct u3phy_info *uinfo)
{
	struct u3p_c60802_regs *info = (struct u3p_c60802_regs *)uinfo->reg_info;
...
void usb_phy_savecurrent_c60802(unsigned int clk_on)
{
	printk(KERN_INFO "%s\n", __func__);
}

void usb_phy_recover_c60802(unsigned int clk_on)
{
	printk(KERN_INFO "%s\n", __func__);
}


static const struct u3phy_operator u3p_c60802_ops = {
	...
	.usb_phy_savecurrent = usb_phy_savecurrent_c60802,
	.usb_phy_recover = usb_phy_recover_c60802,
};

int u3p_c60802_init(struct u3phy_info *info)
{
	info->reg_info = (void *)&g_c60802_regs;
	info->u3p_ops = &u3p_c60802_ops;
}
