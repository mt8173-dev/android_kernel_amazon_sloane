...
#ifdef SUPPORT_U3
	mu3d_setmsk(sif_base, U3D_SSUSB_U3_CTRL_0P,
		    (SSUSB_U3_PORT_DIS | SSUSB_U3_PORT_PDN));
#endif
	mu3d_setmsk(sif_base, U3D_SSUSB_U2_CTRL_0P,
