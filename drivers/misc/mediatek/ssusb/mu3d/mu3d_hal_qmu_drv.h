...
/* #define TGPD_SET_FLAG(_pd, _flag)     ((struct ssusb_gpd *)_pd)->flag = ((((struct ssusb_gpd *)_pd)->flag&(~TGPD_FLAGS_HWO))|(_flag)) */
#define TGPD_GET_FLAG(_pd)		((struct ssusb_gpd *)_pd)->flag
#define TGPD_SET_CHKSUM(_pd, _n)	do { \
...
#define TGPD_SET_FORMAT(_pd, _fmt)	((struct ssusb_gpd *)_pd)->flag = (((struct ssusb_gpd *)_pd)->flag&(~TGPD_FORMAT_BDP))|(_fmt)
...
#define TGPD_SET_NEXT(_pd, _next)	((struct ssusb_gpd *)_pd)->next_gpd = (u32)_next;
#define TGPD_GET_NEXT(_pd)		(u32)((struct ssusb_gpd *)_pd)->next_gpd
/* #define TGPD_SET_TBD(_pd, _tbd)               ((struct ssusb_gpd *)_pd)->buffer = (u32)_tbd; TGPD_SET_FORMAT_BDP(_pd) */
...
#define TGPD_SET_EPaddr(_pd, _EP)		((struct ssusb_gpd *)_pd)->ext_flag = (((struct ssusb_gpd *)_pd)->ext_flag&0xF0)|(_EP)
...
#define TGPD_SET_ZLP(_pd, _ZLP)			((struct ssusb_gpd *)_pd)->ext_flag |= ((_ZLP) ? TGPD_FORMAT_ZLP : 0x00)
