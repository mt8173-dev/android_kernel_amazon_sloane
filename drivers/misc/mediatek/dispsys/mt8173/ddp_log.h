...
#define DISP_LOG_D(fmt, args...)   printk("[DDP/"LOG_TAG"]"fmt, ##args)
#define DISP_LOG_I(fmt, args...)   printk("[DDP/"LOG_TAG"]"fmt, ##args)
#define DISP_LOG_W(fmt, args...)   printk("[DDP/"LOG_TAG"]"fmt, ##args)
#define DISP_LOG_E(fmt, args...)   do {printk("[DDP/"LOG_TAG"]error:"fmt, ##args); dprec_logger_pr(DPREC_LOGGER_ERROR, fmt, ##args); } while (0)
