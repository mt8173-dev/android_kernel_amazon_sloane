...
DPI_STATUS ddp_dpi_ConfigPclk(cmdqRecHandle cmdq, unsigned int mipi_pll_clk_ref,
...
{
	DPI_REG_CNTL pol;
	DPI_REG_BG_HCNTL pol2;
	DPI_REG_BG_VCNTL pol3;
	DPI_REG_BG_COLOR pol4;
