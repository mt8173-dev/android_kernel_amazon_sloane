...
int OVLLayerConfig(unsigned layer, enum OVL_LAYER_SOURCE source, unsigned int fmt, unsigned int addr, unsigned int src_x,	/* ROI x offset */
		   ...
		   bool keyEn, unsigned int key, bool aen, unsigned char alpha);	/* trancparency */
