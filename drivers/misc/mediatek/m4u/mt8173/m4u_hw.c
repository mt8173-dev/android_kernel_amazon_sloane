...
#define M4U1_PORT_INIT(port, tf_id)   1, 0, 6, port, tf_id

m4u_port_t gM4uPort[] = {
	{"DISP_OVL0", M4U0_PORT_INIT(1, 0, 0),},
	{"DISP_RDMA0", M4U0_PORT_INIT(1, 0, 1),},
	{"DISP_WDMA0", M4U0_PORT_INIT(1, 0, 2),},
	{"DISP_OD_R", M4U0_PORT_INIT(1, 0, 3),},
	{"DISP_OD_W", M4U0_PORT_INIT(1, 0, 4),},
	{"MDP_RDMA0", M4U0_PORT_INIT(1, 0, 5),},
	{"MDP_WDMA", M4U0_PORT_INIT(1, 0, 6),},
	{"MDP_WROT0", M4U0_PORT_INIT(1, 0, 7),},
	...
	{"VDEC_TILE", M4U0_PORT_INIT(0, 1, 9),},
	...
	{"CAM_IMGO_D", M4U0_PORT_INIT(0, 2, 5),},
	...
	{"DISP_OVL1", M4U0_PORT_INIT(1, 4, 0),},
	{"DISP_RDMA1", M4U0_PORT_INIT(1, 4, 1),},
	{"DISP_RDMA2", M4U0_PORT_INIT(1, 4, 2),},
	{"DISP_WDMA1", M4U0_PORT_INIT(1, 4, 3),},
	{"MDP_RDMA1", M4U0_PORT_INIT(1, 4, 4),},
	{"MDP_WROT1", M4U0_PORT_INIT(1, 4, 5),},

	{"VENC_RCPU_SET2", M4U0_PORT_INIT(0, 5, 0),},
	{"VENC_REC_FRM_SET2", M4U0_PORT_INIT(0, 5, 1),},
	{"VENC_REF_LUMA_SET2", M4U0_PORT_INIT(0, 5, 2),},
	{"VENC_REF_CHROMA_SET2", M4U0_PORT_INIT(0, 5, 3),},
	{"VENC_BSDMA_SET2", M4U0_PORT_INIT(0, 5, 4),},
	{"VENC_CUR_LUMA_SET2", M4U0_PORT_INIT(0, 5, 5),},
	{"VENC_CUR_CHROMA_SET2", M4U0_PORT_INIT(0, 5, 6),},
	{"VENC_RD_COMV_SET2", M4U0_PORT_INIT(0, 5, 7),},
	{"VENC_SV_COMV_SET2", M4U0_PORT_INIT(0, 5, 8),},

	{"RESERVED", M4U1_PORT_INIT(0, 0xff),},
	{"SPM", M4U1_PORT_INIT(1, 0x50),},
	{"MD32", M4U1_PORT_INIT(2, 0x90),},
	{"PTP_THERM", M4U1_PORT_INIT(3, 0xd0),},
	{"PWM", M4U1_PORT_INIT(4, 0x1),},
	{"MSDC1", M4U1_PORT_INIT(5, 0x21),},
	{"MSDC2", M4U1_PORT_INIT(6, 0x41),},
	{"SPI0", M4U1_PORT_INIT(7, 0x61),},
	{"NFI", M4U1_PORT_INIT(8, 0x8),},
	{"AUDIO", M4U1_PORT_INIT(9, 0x48),},
	{"RESERVED2", M4U1_PORT_INIT(10, 0xfe),},
	{"HSIC_XHCI", M4U1_PORT_INIT(11, 0x9),},
	{"HSIC_MAS", M4U1_PORT_INIT(12, 0x11),},
	{"HSIC_DEV", M4U1_PORT_INIT(13, 0x19),},
	{"AP_DMA", M4U1_PORT_INIT(14, 0x18),},
	{"HSIC_DMA", M4U1_PORT_INIT(15, 0xc8),},
	{"MSDC0", M4U1_PORT_INIT(16, 0x0),},
	{"MSDC3", M4U1_PORT_INIT(17, 0x20),},
	/*{"DEBUGTOP1", M4U1_PORT_INIT(18, 0xC),},*/
	{"UNKOWN", M4U1_PORT_INIT(18, 0xF),},
...
{
	/*larb_clock_on(SMI_CLK_SMI_COMMON);*/
}

static void smi_common_clock_off(void)
{
	/*larb_clock_off(SMI_CLK_SMI_COMMON);*/
}
...
int m4u_hw_init(struct m4u_device *m4u_dev, int m4u_id)
{
	...
	if (ProtectPA & (TF_PROTECT_BUFFER_SIZE - 1)) {
		M4UMSG("protect buffer (0x%lx) not align.\n",
		       (long unsigned int)(ProtectPA & (TF_PROTECT_BUFFER_SIZE - 1)));
		return -1;
	}
