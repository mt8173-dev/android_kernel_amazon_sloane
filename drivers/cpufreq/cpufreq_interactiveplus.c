...
*/
/* temp workaround for kernel coding style check */
show_gov_pol_sys(target_loads);
store_gov_pol_sys(target_loads);
show_gov_pol_sys(above_hispeed_delay);
store_gov_pol_sys(above_hispeed_delay);
show_gov_pol_sys(hispeed_freq);
store_gov_pol_sys(hispeed_freq);
show_gov_pol_sys(go_hispeed_load);
store_gov_pol_sys(go_hispeed_load);
show_gov_pol_sys(min_sample_time);
store_gov_pol_sys(min_sample_time);
show_gov_pol_sys(timer_rate);
store_gov_pol_sys(timer_rate);
show_gov_pol_sys(timer_slack);
store_gov_pol_sys(timer_slack);
show_gov_pol_sys(boost);
store_gov_pol_sys(boost);
store_gov_pol_sys(boostpulse);
show_gov_pol_sys(boostpulse_duration);
store_gov_pol_sys(boostpulse_duration);
show_gov_pol_sys(io_is_busy);
store_gov_pol_sys(io_is_busy);
...
*/
/* temp workaround for kernel coding style check */
gov_sys_attr_rw(target_loads);
gov_pol_attr_rw(target_loads);
gov_sys_attr_rw(above_hispeed_delay);
gov_pol_attr_rw(above_hispeed_delay);
gov_sys_attr_rw(hispeed_freq);
gov_pol_attr_rw(hispeed_freq);
gov_sys_attr_rw(go_hispeed_load);
gov_pol_attr_rw(go_hispeed_load);
gov_sys_attr_rw(min_sample_time);
gov_pol_attr_rw(min_sample_time);
gov_sys_attr_rw(timer_rate);
gov_pol_attr_rw(timer_rate);
gov_sys_attr_rw(timer_slack);
gov_pol_attr_rw(timer_slack);
gov_sys_attr_rw(boost);
gov_pol_attr_rw(boost);
gov_sys_attr_rw(boostpulse_duration);
gov_pol_attr_rw(boostpulse_duration);
gov_sys_attr_rw(io_is_busy);
gov_pol_attr_rw(io_is_busy);
...
MODULE_DESCRIPTION("'cpufreq_interactiveplus' - A cpufreq governor for latency sensitive workloads");
MODULE_LICENSE("GPL");
