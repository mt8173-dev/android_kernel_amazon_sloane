...
VOID cnmChMngrAbortPrivilege(P_ADAPTER_T prAdapter, P_MSG_HDR_T prMsgHdr)
{
	...
	DBGLOG(CNM, INFO, ("ChAbort net=%d token=%d b=%d c=%d s=%d w=%d s1=%d s2=%d\n",
			   prCmdBody->ucBssIndex, prCmdBody->ucTokenID,
			   prCmdBody->ucRfBand, prCmdBody->ucPrimaryChannel,
			   prCmdBody->ucRfSco, prCmdBody->ucRfChannelWidth,
			   prCmdBody->ucRfCenterFreqSeg1, prCmdBody->ucRfCenterFreqSeg2));
