...
static const UINT_16 g_u2CountryGroup14[] = {
	COUNTRY_CODE_EU, COUNTRY_CODE_PH, COUNTRY_CODE_TR, COUNTRY_CODE_IR, COUNTRY_CODE_BY,
	COUNTRY_CODE_LK
};
...
{
#define REG_DOMAIN_DEF_IDX          15	/* WW:world wide */
#define REG_DOMAIN_GROUP_NUM \
	 ...
	 * The final one is for World Wide region with CH14 included in its channel list  now.
	 */
