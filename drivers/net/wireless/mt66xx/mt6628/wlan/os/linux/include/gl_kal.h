...
#define kalMemAlloc(u4Size, eMemType) ({    \
	...
	pr_info(DRV_NAME "0x%p(%ld) allocated (%s:%s)\n", \
...
#define kalMemFree(pvAddr, eMemType, u4Size)  \
	...
	if (pvAddr) {   \
	    allocatedMemSize -= u4Size; \
	    pr_info(DRV_NAME "0x%p(%ld) freed (%s:%s)\n", \
		pvAddr, (UINT_32)u4Size, __FILE__, __func__);  \
	}   \
	if (eMemType == PHY_MEM_TYPE) { \
	    kfree(pvAddr); \
...
#define AIS_WARN_LOGFUNC(_Fmt...) pr_warn(XLOG_TAG _Fmt)
#define AIS_INFO_LOGFUNC(_Fmt...)
#define AIS_STATE_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
...
#define INIT_ERROR_LOGFUNC(_Fmt...) pr_err(XLOG_TAG _Fmt)
#define INIT_WARN_LOGFUNC(_Fmt...) pr_warn(XLOG_TAG _Fmt)
#define INIT_INFO_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define INIT_STATE_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define INIT_EVENT_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define INIT_TRACE_LOGFUNC(_Fmt...) pr_debug(XLOG_TAG _Fmt)
...
#define AAA_ERROR_LOGFUNC(_Fmt...) pr_err(XLOG_TAG _Fmt)
#define AAA_WARN_LOGFUNC(_Fmt...) pr_warn(XLOG_TAG _Fmt)
#define AAA_INFO_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define AAA_STATE_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define AAA_EVENT_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define AAA_TRACE_LOGFUNC(_Fmt...) pr_debug(XLOG_TAG _Fmt)
...
#define ROAMING_ERROR_LOGFUNC(_Fmt...) pr_err(XLOG_TAG _Fmt)
#define ROAMING_WARN_LOGFUNC(_Fmt...) pr_warn(XLOG_TAG _Fmt)
#define ROAMING_INFO_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define ROAMING_STATE_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define ROAMING_EVENT_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define ROAMING_TRACE_LOGFUNC(_Fmt...) pr_debug(XLOG_TAG _Fmt)
...
#define TX_TRACE_LOGFUNC(_Fmt...) pr_debug(XLOG_TAG _Fmt)
...
#define RLM_ERROR_LOGFUNC(_Fmt...) pr_err(XLOG_TAG _Fmt)
#define RLM_WARN_LOGFUNC(_Fmt...) pr_warn(XLOG_TAG _Fmt)
#define RLM_INFO_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
...
#define CNM_ERROR_LOGFUNC(_Fmt...) pr_err(XLOG_TAG _Fmt)
#define CNM_WARN_LOGFUNC(_Fmt...) pr_warn(XLOG_TAG _Fmt)
#define CNM_INFO_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
...
#define RSN_ERROR_LOGFUNC(_Fmt...) pr_err(XLOG_TAG _Fmt)
#define RSN_WARN_LOGFUNC(_Fmt...) pr_warn(XLOG_TAG _Fmt)
#define RSN_INFO_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define RSN_STATE_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
#define RSN_EVENT_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
...
#define P2P_ERROR_LOGFUNC(_Fmt...) pr_err(XLOG_TAG _Fmt)
#define P2P_WARN_LOGFUNC(_Fmt...)  pr_warn(XLOG_TAG _Fmt)
#define P2P_INFO_LOGFUNC(_Fmt...)  pr_info(XLOG_TAG _Fmt)
...
#define QM_ERROR_LOGFUNC(_Fmt...) pr_err(XLOG_TAG _Fmt)
#define QM_WARN_LOGFUNC(_Fmt...)  pr_warn(XLOG_TAG _Fmt)
#define QM_INFO_LOGFUNC(_Fmt...)  pr_info(XLOG_TAG _Fmt)
#define QM_STATE_LOGFUNC(_Fmt...)
#define QM_EVENT_LOGFUNC(_Fmt...)
#define QM_TRACE_LOGFUNC(_Fmt...) pr_debug(XLOG_TAG _Fmt)
...
#define HAL_ERROR_LOGFUNC(_Fmt...) pr_err(XLOG_TAG _Fmt)
...
#define SW4_INFO_LOGFUNC(_Fmt...) pr_info(XLOG_TAG _Fmt)
...
extern enum _ENUM_WMTHWVER_TYPE_T mtk_wcn_wmt_hwver_get(VOID);
#elif defined(MT5931) && CFG_MULTI_ECOVER_SUPPORT
enum _ENUM_HWVER_TYPE_T {
	HWVER_MT5931_E1 = 0x1,
	HWVER_MT5931_E2 = 0x2,
	HWVER_MT5931_E3 = 0x3,
	HWVER_MT5931_MAX,
