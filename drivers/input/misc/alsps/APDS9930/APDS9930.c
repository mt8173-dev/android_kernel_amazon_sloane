...
#define APS_FUN(f)               pr_err(KERN_ERR APS_TAG"%s\n", __func__)
#define APS_ERR(fmt, args...)    pr_err(KERN_ERR  APS_TAG"%s %d : "fmt, __func__, __LINE__, ##args)
#define APS_LOG(fmt, args...)    pr_err(KERN_ERR APS_TAG fmt, ##args)
#define APS_DBG(fmt, args...)    pr_info(KERN_INFO APS_TAG fmt, ##args)
...
static int APDS9930_probe(struct platform_device *pdev)
{
	...
	APS_ERR("alsps platform_get_irq APDS9930_probe");
