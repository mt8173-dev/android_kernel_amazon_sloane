...
#include "disp_drv.h"
#endif
#if defined(CONFIG_ARCH_MT6595)|defined(CONFIG_ARCH_MT8173)
...
*/
static const struct of_device_id mt_tpd_of_match[] = {
	{.compatible = "mediatek,TPD",},
	{},
};

MODULE_DEVICE_TABLE(of, mt_tpd_of_match);
#endif
...
static struct platform_driver tpd_driver = {
	...
	.driver = {
		   .name = TPD_DEVICE,
#ifdef CONFIG_OF
		   .of_match_table = mt_tpd_of_match,
#endif
		   },
};
