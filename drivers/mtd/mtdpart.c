...
ssize_t mtd_writeable_proc_write(struct file *file, const char __user *buffer, size_t count, loff_t *data);

struct mtd_change {
    uint64_t size;
    uint64_t offset;
};
ssize_t mtd_change_proc_write(struct file *file, const char __user *buffer, size_t count, loff_t *data);
#endif
