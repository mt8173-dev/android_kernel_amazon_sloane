...
extern ssize_t mtd_writeable_proc_write(struct file *file, const char __user *buffer, size_t count, loff_t *data);
extern ssize_t mtd_change_proc_write(struct file *file, const char __user *buffer, size_t count, loff_t *data);
#endif
