...
int ion_heap_map_user(struct ion_heap *, struct ion_buffer *, struct vm_area_struct *);
...
struct ion_heap *ion_mm_carveout_heap_create(struct ion_platform_heap *);
void ion_mm_carveout_heap_destroy(struct ion_heap *);
